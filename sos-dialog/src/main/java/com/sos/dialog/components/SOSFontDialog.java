/*
 * Created on 03.09.2010 To change the template for this generated file go to
...
public class SOSFontDialog extends SOSPreferenceStore {
    ...
    public void show(final Display pobjDisplay) {
        ...
        // brown fox jumps over the lazy poddle.
        ...
        // SOSJOEMessageCodes.JOE_B_FontDialog_Change.Control(new Button(s,
        // SWT.PUSH | SWT.BORDER));
        ...
        // Button btnSave = SOSJOEMessageCodes.JOE_B_FontDialog_Save.Control(new
        // Button(s, SWT.NONE));
        ...
        // Button btnReset =
        // SOSJOEMessageCodes.JOE_B_FontDialog_Reset.Control(new Button(s,
        // SWT.NONE));
        ...
        // Button btnCancel =
        // SOSJOEMessageCodes.JOE_B_FontDialog_Cancel.Control(new Button(s,
        // SWT.NONE));

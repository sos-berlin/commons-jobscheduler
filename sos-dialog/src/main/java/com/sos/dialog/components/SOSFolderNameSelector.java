...
public class SOSFolderNameSelector extends SOSPreferenceStoreText {
    ...
    private final String conClassName = "SOSFolderNameSelector";
    @SuppressWarnings("unused")
    private final String conSVNVersion = "$Id: FolderNameSelector.java 25898 2014-06-20 14:36:54Z kb $";
            ...
            public void mouseDoubleClick(MouseEvent arg0) {
                ...
                if (strT.length() > 0) {
                    ...
                    if (objFile.canRead()) {
                        ...
                        // applyFile2Include();
                        // objParentForm.setStatusLine(String.format("Directory '%1$s' selected",
                        // strT));
                    } else {
                        // objParentForm.MsgWarning(String.format("Directory '%1$s' is not readable",
                        // strT));
                    }
                }
                // objParentForm.restoreCursor();

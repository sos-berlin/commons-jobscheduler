...
public class JadeFilesDBItem extends DbItem {
    ...
    // private List <JadeFilesHistoryDBItem> jadeFilesHistoryDBItems = new
    // ArrayList <JadeFilesHistoryDBItem>();
    // private Session session;

    /*
     * @OneToMany(mappedBy="`sosftpId`") public List<JadeFilesHistoryDBItem>
     * getJadeFilesHistoryDBItems() { return jadeFilesHistoryDBItems; } public
     * void setJadeFilesHistoryDBItems(List<JadeFilesHistoryDBItem>
     * jadeFilesHistoryDBItems) { this.jadeFilesHistoryDBItems =
     * jadeFilesHistoryDBItems; }
     */
     ...
     * history.setJadeFilesDBItem(this); } //save the 1 and all n HistoryItems
     * for 1 public void save() { session.save(this); for (int i =
     * 0;i<jadeFilesHistoryDBItems.size();i++) { JadeFilesHistoryDBItem h =
     * (JadeFilesHistoryDBItem)jadeFilesHistoryDBItems.get(i); session.save(h);
     * } }
     */
}

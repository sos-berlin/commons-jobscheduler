...
public class JADEProfileIncludes {

    @XmlElement(required = true)
    protected List<MergeElement> merge = new Vector<MergeElement>();
     ...
     * 
     */
    public List<MergeElement> getMerge() {
        if (merge == null) {
            merge = new Vector<MergeElement>();
        }
        return merge;
    }

...
public class SOSSSHJob2Test extends JSJobUtilitiesClass<SOSSSHJobOptions> {
    ...
    public void testExecute() throws Exception {
        initializeClazz();
        String strArgs[] = new String[] { "-command", "ls", "-auth_method", "password", "-host", "wilma.sos", "-auth_file=test", "-user=test", "-password",
                "12345" };
    ...
    public void testExecuteUsingKeyFile() throws Exception {
        initializeClazz();
        String strArgs[] = new String[] { "-command", "ls", "-auth_method=publickey", "-host", "wilma.sos", "-auth_file=./src/test/resources/testing-key.key",
    ...
    public void testExecuteCmdScriptFile() throws Exception {
        initializeClazz();
        String strArgs[] = new String[] { "-command_script_file", "R:/nobackup/junittests/testdata/SSH/hostname.sh", "-auth_method", "password", "-host",
                "wilma.sos", "-auth_file", "test", "-user", "test", "-password", "12345" };
        objOptions.CommandLineArgs(strArgs);
        objSSH.execute();
        assertEquals("auth_file", objOptions.auth_file.Value(), "test");
        assertEquals("user", objOptions.user.Value(), "test");

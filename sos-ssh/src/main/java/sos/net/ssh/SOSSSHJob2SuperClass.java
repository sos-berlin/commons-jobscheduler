...
public class SOSSSHJob2SuperClass extends JSToolBox {
    ...
    protected Connection getBaseAuthentication() throws Exception {
        ...
        try { // to connect and authenticate
            ...
            if (!isAuthenticated) {
                throw new Exception("authentication failed [host=" + objOptions.host.Value() + ", port=" + objOptions.port.Value() + ", user:"
                        + objOptions.user.Value() + ", auth_method=" + objOptions.auth_method.Value());
            }

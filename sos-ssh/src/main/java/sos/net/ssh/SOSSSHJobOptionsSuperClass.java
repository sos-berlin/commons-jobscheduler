 ...
 * OptionsClass.tpl durch ClaviusXPress automatisch erzeugt. Zum Hinzuf�gen
 * oder �ndern von Optionen m�ssen die folgenden Zeilen in eine Datei
 * extrahiert und mit CxP diese Klasse erneut erzeugt werden.
 * 
 ...
 * PackageName=com.sos.net.ssh . ClassName=SOSSSHJobOptions . Title=Launch
 * remote commands or executable files by SSH . Description=Launch remote
 * commands or executable files by SSH .
 ...
 * (HashMap <String, String> pobjHM) { pobjHM.put ("SOSSSHJobOptions.auth_file",
 * "test"); // This parameter specifies the path and name of a user's pr
 * pobjHM.put ("SOSSSHJobOptions.auth_method", "publickey"); // This parameter
 * specifies the authorization method for the pobjHM.put
 * ("SOSSSHJobOptions.command", "test"); // This parameter specifies a command
 * that is to be executed pobjHM.put ("SOSSSHJobOptions.command_delimiter",
 * "%%"); // Command delimiter characters are specified using this par
 * pobjHM.put ("SOSSSHJobOptions.command_script", "test"); // This parameter can
 * be used as an alternative to command, pobjHM.put
 * ("SOSSSHJobOptions.command_script_file", "test"); // This parameter can be
 * used as an alternative to command, pobjHM.put
 * ("SOSSSHJobOptions.command_script_param", "test"); // This parameter contains
 * a parameterstring, which will be pobjHM.put ("SOSSSHJobOptions.host",
 * "test"); // This parameter specifies the hostname or IP address of th
 * pobjHM.put ("SOSSSHJobOptions.ignore_error", "false"); // Should the value
 * true be specified, then execution errors pobjHM.put
 * ("SOSSSHJobOptions.ignore_exit_code", "test"); // This parameter configures
 * one or more exit codes which wi pobjHM.put ("SOSSSHJobOptions.ignore_signal",
 * "false"); // Should the value true be specified, then on pobjHM.put
 * ("SOSSSHJobOptions.ignore_stderr", "false"); // This job checks if any output
 * to stderr has been created pobjHM.put ("SOSSSHJobOptions.password", "test");
 * // This parameter specifies the user account password for au pobjHM.put
 * ("SOSSSHJobOptions.port", "22"); // This parameter specifies the port number
 * of the SSH serve pobjHM.put ("SOSSSHJobOptions.proxy_host", "test"); // The
 * value of this parameter is the host name or the IP ad pobjHM.put
 * ("SOSSSHJobOptions.proxy_password", "test"); // This parameter specifies the
 * password for the proxy serve pobjHM.put ("SOSSSHJobOptions.proxy_port",
 * "test"); // This parameter specifies the port number of the proxy, pobjHM.put
 * ("SOSSSHJobOptions.proxy_user", "test"); // The value of this parameter
 * specifies the user account fo pobjHM.put ("SOSSSHJobOptions.simulate_shell",
 * "false"); // Should the value true be specified for this parameter,
 * pobjHM.put ("SOSSSHJobOptions.simulate_shell_inactivity_timeout", "test"); //
 * If no new characters are written to stdout or stderr afte pobjHM.put
 * ("SOSSSHJobOptions.simulate_shell_login_timeout", "test"); // If no new
 * characters are written to stdout or stderr afte pobjHM.put
 * ("SOSSSHJobOptions.simulate_shell_prompt_trigger", "test"); // The expected
 * comman line prompt. Using this prompt the jo pobjHM.put
 * ("SOSSSHJobOptions.user", "test"); // This parameter specifies the user
 * account to be used when return pobjHM; } // private void
...
public class SOSSSHJobOptionsSuperClass extends JSOptionsClass implements ISOSConnectionOptions, ISOSAuthenticationOptions, ISOSShellOptions,
     ...
     * (non-Javadoc)
     * @see
     * com.sos.VirtualFileSystem.Options.ISOSDataProviderOptions#seturl(com.sos
     * .JSHelper.Options.SOSOptionUrl)
     */
    ...
    /** \option raise_exception_on_error \type SOSOptionBoolean \brief
     * raise_exception_on_error - Raise an exception if an error occured
     * 
     * \details Raise an Exception if an error occured
     * 
     * \mandatory: true
     * 
    ...
    // @JSOptionDefinition(name = "osProfile", description =
    // "This parameter can be used to define the ini file with the os specific commands for the process monitoring",
    // key = "osProfile", type = "SOSOptionIniFileName", mandatory = false)
    // public SOSOptionString osProfile = new SOSOptionString(this, conClassName
    // + ".osProfile",
    // "This parameter can be used to define the ini file with the os specific commands for the process monitoring",
    // // Titel
    // "", // InitValue
    ...
    public SOSOptionBoolean runWithWatchdog = new SOSOptionBoolean(this, conClassName + ".runWithWatchdog", "This parameter can be used to activate ssh session management", // Titel
    "false", // InitValue
    "false", // DefaultValue
    false // isMandatory
    );
    ...
    public SOSOptionBoolean createEnvironmentVariables = new SOSOptionBoolean(this, conClassName + ".createEnvironmentVariables", "This parameter can be used to activate ssh environment variables", // Titel
    "true", // InitValue
    "true", // DefaultValue
    false // isMandatory
    );
    ...
    public SOSOptionString cleanupJobchain = new SOSOptionString(this, conClassName + ".cleanupJobchain", "This parameter is used to determine the name of the jobchain for cleanup", // Titel
    "", // InitValue
    "", // DefaultValue
    false // isMandatory
    );
    ...
    public SOSOptionString ssh_job_kill_pid_command = new SOSOptionString(this, conClassName + ".ssh_job_kill_pid_command", "The command to to kill a remote running pid", // Titel
    "", // InitValue
    ...
    public SOSOptionString ssh_job_terminate_pid_command = new SOSOptionString(this, conClassName + ".ssh_job_terminate_pid_command", "The command to to terminate a remote running pid", // Titel
    "", // InitValue
    ...
    public SOSOptionString ssh_job_get_pid_command = new SOSOptionString(this, conClassName + ".ssh_job_get_pid_command", "The command to get the PID of the active shell", // Titel
    "", // InitValue
    "echo $$", // DefaultValue
    false // isMandatory
    );
    ...
    public SOSOptionString ssh_job_get_child_processes_command = new SOSOptionString(this, conClassName + ".ssh_job_get_child_processes_command", "The command to get the child processes related to the given pid", // Titel
    "", // InitValue
    ...
    public SOSOptionString ssh_job_get_active_processes_command = new SOSOptionString(this, conClassName + ".ssh_job_get_active_processes_command", "The command to check if the given process is still running", // Titel
    "", // InitValue
    ...
    public SOSOptionInteger ssh_job_timeout_kill_after = new SOSOptionInteger(this, conClassName + ".ssh_job_timeout_kill_after", "The timeout in seconds after which a kill signal will be send", // Titel
    "", // InitValue
    "", // DefaultValue
    false // isMandatory
    );
     ...
     * <name>SOSSSHJobOptions</name> <title>This parameter specifies the user
     * account to be used when</title> <description> <para> Konstruktor
     * SOSSSHJobOptions, als Parameter eine HashMap mit den Optionen (so wie es
     * im DataSwitch Standard ist). Dieser Konstruktor mappt die Werte aus der
     ...
     * <keyword>SOSSSHJobOptions:Class</keyword> </keywords> <categories>
     ...
     * 
     * \details In der als Parameter anzugebenden HashMap sind Schl�ssel
     * (Name) und Wert der jeweiligen Option als Paar angegeben. Ein Beispiel
     * f�r den Aufbau einer solchen HashMap findet sich in der Beschreibung
     * dieser Klasse (\ref TestData "setJobSchedulerSSHJobOptions"). In dieser
     * Routine werden die Schl�ssel analysiert und, falls gefunden, werden die

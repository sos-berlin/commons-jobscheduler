 ...
 *
 * \details
 * Testet die Klasse JSOptionValueList
 *
...
public class JSOptionValueListTest {
	...
	public void testConcatenatedValue2() throws Exception {
		...
		assertEquals("ConcatenatedValue::Single SQL Stmt1",
				strStatements[0],
	...
	public void testConcatenatedValue3() throws Exception {
		...
		assertEquals("ConcatenatedValue::Single SQL Stmt2",
				strStatements[0],
				optionValueList.concatenatedValue(strDelimiter));
	...
	public void testConcatenatedValue4() throws Exception {
		...
		assertEquals("ConcatenatedValue::Multiple SQL Stmt1",
				strStatements[0] + strStatements[1],
				optionValueList.concatenatedValue(strDelimiter));
	...
	public void testConcatenatedValue5() throws Exception {
		...
		assertEquals("ConcatenatedValue::Multiple SQL Stmt2",
				strStatements[0] + strDelimiter + strStatements[1],
				optionValueList.concatenatedValue(strDelimiter));
	...
	public void testConcatenatedValue6() throws Exception {
		...
		assertEquals("ConcatenatedValue::Multiple SQL Stmt2b",
				strStatements[0] + strStatements[1] + strDelimiter + strStatements[2],
				optionValueList.concatenatedValue(strDelimiter));
	...
	public void testAppendValue() throws Exception {
		...
		assertTrue("contains SELECT * FROM HALLO", objVL.contains("SELECT * FROM HALLO"));
		System.out.println("JSOptionValueListTest.testAppendValue()"
				+ objVL.concatenatedValue(";"));
...
//	@Ignore   // Test is not really complete !?
	public void testValue() throws Exception {
		...
		settings.put(strKey + "3", strStatements[2]);
		optionValueList = new JSOptionValueList(objOptions, strKey, strDescr + "7", "", true);
		optionValueList.Value("SELECT * FROM HALLO;SELECT ABC FROM TABELLE1;");
		assertEquals("Value failed", strStatements[0], optionValueList.Value());
	}

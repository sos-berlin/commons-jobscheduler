 ...
 * \author KB
 * 
 * @version $Id$13.09.2010 \see reference
 *
...
public class SOSOptionRegExpTest {
    ...
    public void testDoReplace() throws Exception {
        ...
        // doTest ("Prefix", "Hello", "\\-;\\2", "prefix1abc12def123.txt",
        // "1abc12def123.txt");
        ...
        /** a little bit more complicated: the first 5 and the last chars are
         * part of the new string. the 6 chars in the middle are discarded. the
         * "non-standard" pattern \- is used to indicate, that this group has to
         * be discarded in the resulting text. As an alternative it is possible
         * to use an empty item ";;". */
        strReplaceWhat = "(.{5})(.{6})(.*)";
        // strReplaceWith = "\\1;\\-;\\3;";
        strReplaceWith = "\\1;;\\3;";
        ...
        /** now we have a prefix with the value but we have to delete it on the
         * result-value */
        ...
        doTestReplace("Prefix", "(prefix)(.*)", "\\2", "prefix1abc12def123.txt", "1abc12def123.txt");
        /*
         * Introducing a "non-regexp" feature: date-variable. The format has to
         * be given as a valid java-daten-format mask.
         */
        ...
        /** just another variable: filename uppercase- or lowercase-conversion is
         * possible. the type of conversion is indicated by writing "uppercase"
         * oder "lowercase" after the colon. */
    ...
    public void testDoRegExReplace() throws Exception {
        objRE = new SOSOptionRegExp(null, "test", "TestOption", "", "", false);
        // doRegExTest ("ausschneiden", "(.*)(\\.DAT)(\\.SHRTIS001_DOR)",
        // "[filename:]$1$2",
        // "20120613_144343_SHRTIS001_0000000001011689.DAT.SHRTIS001_DOR",
        // "20120613_144343_SHRTIS001_0000000001011689.DAT" );
        // doRegExTest ("ausschneiden", "(.*)(\\.DAT)(\\.SHRTIS001_DOR)",
        // "[date:]$1$2",
        // "20120613_144343_SHRTIS001_0000000001011689.DAT.SHRTIS001_DOR",
        // "20120613_144343_SHRTIS001_0000000001011689.DAT" );
        doRegExTest("ausschneiden", "(.*)(\\.DAT)(\\.SHRTIS001_DOR)", "$1$2", "20120613_144343_SHRTIS001_0000000001011689.DAT.SHRTIS001_DOR", "20120613_144343_SHRTIS001_0000000001011689.DAT");
    }

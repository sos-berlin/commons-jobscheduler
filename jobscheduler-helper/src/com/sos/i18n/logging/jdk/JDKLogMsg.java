...
/**
 * <p>This class provides alot of static methods to assist in logging localized messages via a JDK logging log
 * object.</p>
 *
 ...
 * exception classes (see {@link JDKLogMsg#fatal(Logger, Throwable, Msg.BundleBaseName, Locale, String, Object[])}
 * and {@link LocalizedException#LocalizedException(Throwable, Msg.BundleBaseName, Locale, String, Object[])} as
 * examples).</p>
 *
 * <p>These static utility methods respect the settings defined by
 * {@link com.sos.i18n.Logger#setDumpStackTraces(boolean)} and {@link com.sos.i18n.Logger#setDumpLogKeys(boolean)}.</p>
 *
 * <p>These are the mappings between the logical log levels and the actual JDK log levels:
 *
 * <ul>
 *   <li>FATAL -> SEVERE</li>
 *   <li>ERROR -> SEVERE</li>
...
public class JDKLogMsg
{
    ...
    */
   public static Msg fatal( Logger         log,
    ...
    * @return if the message was logged, a non-<code>null</code> Msg object is returned
    */
   public static Msg error( Logger         log,
                            BundleBaseName basename,
                            Locale         locale,
                            String         key,
                            Object...      varargs )
    ...
    * @return if the message was logged, a non-<code>null</code> Msg object is returned
    */
   public static Msg warn( Logger         log,
                           BundleBaseName basename,
                           Locale         locale,
                           String         key,
                           Object...      varargs )
    ...
    * @return if the message was logged, a non-<code>null</code> Msg object is returned
    */
   public static Msg info( Logger         log,
                           BundleBaseName basename,
                           Locale         locale,
                           String         key,
                           Object...      varargs )
    ...
    * @return if the message was logged, a non-<code>null</code> Msg object is returned
    */
   public static Msg debug( Logger         log,
                            BundleBaseName basename,
                            Locale         locale,
                            String         key,
                            Object...      varargs )
    ...
    * @return if the message was logged, a non-<code>null</code> Msg object is returned
    */
   public static Msg trace( Logger         log,
                            BundleBaseName basename,
                            Locale         locale,
                            String         key,
                            Object...      varargs )
    ...
    * {@link com.sos.i18n.Logger#getDumpStackTraces() stack traces are not to be dumped}, it doesn't matter. FATAL log
    * level messages should be very rare and normally indicate a very bad condition. In this case, we should always
    * dump the stack trace no matter how we are configured.
    *
    ...
    */
   private static void logFatalWithThrowable( Logger    log,
                                              String    key,
                                              Msg       msg,
                                              Throwable throwable )
   {
    ...
    * {@link com.sos.i18n.Logger#getDumpStackTraces() stack traces are not to be dumped}, the logged message will be
    * appended with the throwable's <code>Throwable.toString()</code> contents.
    *
    * @param log       where to log the message
    * @param key       the resource key that is associated with the message
    * @param msg       the message to log
    * @param throwable the throwable associated with the message
    */
   private static void logErrorWithThrowable( Logger    log,
                                              String    key,
                                              Msg       msg,
                                              Throwable throwable )
   {
      ...
      {
         log.severe( ( ( com.sos.i18n.Logger.getDumpLogKeys() ) ? ( '{' + key + '}' + msg ) : msg )
    ...
    * @param throwable the throwable associated with the message
    */
   private static void logWarnWithThrowable( Logger    log,
                                             String    key,
                                             Msg       msg,
                                             Throwable throwable )
   {
      ...
      {
         log.warning( ( ( com.sos.i18n.Logger.getDumpLogKeys() ) ? ( '{' + key + '}' + msg ) : msg )
                      + ". Cause: " + throwable.toString() );
      }
   }
    ...
    * @param throwable the throwable associated with the message
    */
   private static void logInfoWithThrowable( Logger    log,
                                             String    key,
                                             Msg       msg,
                                             Throwable throwable )
   {
      ...
      {
         log.info( ( ( com.sos.i18n.Logger.getDumpLogKeys() ) ? ( '{' + key + '}' + msg ) : msg )
                   + ". Cause: " + throwable.toString() );
      }
   }
    ...
    * @param throwable the throwable associated with the message
    */
   private static void logDebugWithThrowable( Logger    log,
                                              String    key,
                                              Msg       msg,
                                              Throwable throwable )
   {
      ...
      {
         log.fine( ( ( com.sos.i18n.Logger.getDumpLogKeys() ) ? ( '{' + key + '}' + msg ) : msg )
                   + ". Cause: " + throwable.toString() );
      }
   }
    ...
    * @param throwable the throwable associated with the message
    */
   private static void logTraceWithThrowable( Logger    log,
                                              String    key,
                                              Msg       msg,
                                              Throwable throwable )
   {
      ...
      {
         log.finest( ( ( com.sos.i18n.Logger.getDumpLogKeys() ) ? ( '{' + key + '}' + msg ) : msg )
                     + ". Cause: " + throwable.toString() );
      }
   }

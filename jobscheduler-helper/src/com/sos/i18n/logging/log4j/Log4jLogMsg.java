...
/**
 * <p>This class provides alot of static methods to assist in logging localized messages via a Log4J logging log
 * object.</p>
 *
 ...
 * {@link Log4jLogMsg#fatal(org.apache.log4j.Logger, Throwable, Msg.BundleBaseName, Locale, String, Object[])} and
 * {@link LocalizedException#LocalizedException(Throwable, Msg.BundleBaseName, Locale, String, Object[])} as
 * examples).</p>
 *
...
public class Log4jLogMsg
{
    ...
    */
   private static void logFatalWithThrowable( org.apache.log4j.Logger log,
                                              String                  key,
                                              Msg                     msg,
                                              Throwable               throwable )
   {
    ...
    * @param throwable the throwable associated with the message
    */
   private static void logErrorWithThrowable( org.apache.log4j.Logger log,
                                              String                  key,
                                              Msg                     msg,
                                              Throwable               throwable )
   {
    ...
    * @param throwable the throwable associated with the message
    */
   private static void logWarnWithThrowable( org.apache.log4j.Logger log,
                                             String                  key,
                                             Msg                     msg,
                                             Throwable               throwable )
   {
    ...
    * @param throwable the throwable associated with the message
    */
   private static void logInfoWithThrowable( org.apache.log4j.Logger log,
                                             String                  key,
                                             Msg                     msg,
                                             Throwable               throwable )
   {
    ...
    * @param throwable the throwable associated with the message
    */
   private static void logDebugWithThrowable( org.apache.log4j.Logger log,
                                              String                  key,
                                              Msg                     msg,
                                              Throwable               throwable )
   {
    ...
    * @param throwable the throwable associated with the message
    */
   private static void logTraceWithThrowable( org.apache.log4j.Logger log,
                                              String                  key,
                                              Msg                     msg,
                                              Throwable               throwable )
   {

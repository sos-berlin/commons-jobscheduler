...
/**
 * Stellt für Klassen einen Message-Mechanismus zur Verfügung.
 * Andere Objekte können sich an Objekte dieser Klasse registrieren, um
 * von deren Tätigkeit informiert zu werden (Listener). Diese Listener müssen
 * von der Klasse JSListener abgeleitet sein.
 * Zusätzlich gibt die Methode SignalDebug die Möglichkeit in Abhängikeit eines
 * maximalen Debug-Levels, Debug-Meldungen bis zu dem maximalen Debug Level
 * ausgeben zu lassen oder eben zu unterdrücken (im Produktivbetrieb).

...
/**
 * \class 		PropertyFactoryOptionsSuperClass - PropertyFactora - a Factoroy to maintain I18N Files
 *
 * \brief 
 * An Options-Super-Class with all Options. This Class will be extended by the "real" Options-class (\see PropertyFactoryOptions.
 ...
 * 
 * \verbatim ;
 * mechanicaly created by com/sos/resources/xsl/jobdoc/sourcegenerator/java/JSJobDoc2JSOptionSuperClass.xsl from http://www.sos-berlin.com at 20141009200110 
 * \endverbatim
 ...
 * \verbatim
 private HashMap <String, String> SetJobSchedulerSSHJobOptions (HashMap <String, String> pobjHM) {
	pobjHM.put ("		PropertyFactoryOptionsSuperClass.auth_file", "test");  // This parameter specifies the path and name of a user's pr
		return pobjHM;
 ...
 *
 */
    @JSOptionDefinition(name = "PropertyFileNamePrefix", 
    description = "", 
    key = "PropertyFileNamePrefix", 
    type = "SOSOptionString", 
    mandatory = true)
...
/**
 * \var SourceFolderName : The Folder, which has all the I18N Property files.
 * The Folder, which has all the I18N Property files.
 *
 */
    @JSOptionDefinition(name = "SourceFolderName", 
    description = "The Folder, which has all the I18N Property files.", 
...
/**
 * \brief setSourceFolderName : The Folder, which has all the I18N Property files.
 * 
 * \details
 * The Folder, which has all the I18N Property files.
 *

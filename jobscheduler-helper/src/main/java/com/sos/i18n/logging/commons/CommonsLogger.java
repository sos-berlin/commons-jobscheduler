...
/** Similar in functionality to the {@link CommonsLogMsg} utility class, this
...
public class CommonsLogger extends Logger {
    ...
    public CommonsLogger(String name, Msg.BundleBaseName basename, Locale locale) {
        super(name, basename, locale);
    }

    /** @see Logger#Logger(Class, Msg.BundleBaseName, Locale) */
    public CommonsLogger(Class clazz, Msg.BundleBaseName basename, Locale locale) {
        super(clazz, basename, locale);
    }

    /** @see Logger#Logger(String, Msg.BundleBaseName) */
    public CommonsLogger(String name, Msg.BundleBaseName basename) {
        super(name, basename);
    }

    /** @see Logger#Logger(Class, Msg.BundleBaseName) */
    public CommonsLogger(Class clazz, Msg.BundleBaseName basename) {
        super(clazz, basename);
    }

    /** @see Logger#Logger(String, Locale) */
    public CommonsLogger(String name, Locale locale) {
        super(name, locale);
    }

    /** @see Logger#Logger(Class, Locale) */
    public CommonsLogger(Class clazz, Locale locale) {
        super(clazz, locale);
    }
    ...
    /** Calls
     * {@link CommonsLogMsg#fatal(Log, Msg.BundleBaseName, Locale, String, Object[])}
     * to log the message.
     *
    ...
    /** Calls
     * {@link CommonsLogMsg#error(Log, Throwable, Msg.BundleBaseName, Locale, String, Object[])}
     * to log the message.
     *
    ...
    /** Calls
     * {@link CommonsLogMsg#error(Log, Msg.BundleBaseName, Locale, String, Object[])}
     * to log the message.
     *
    ...
    /** Calls
     * {@link CommonsLogMsg#warn(Log, Throwable, Msg.BundleBaseName, Locale, String, Object[])}
     * to log the message.
     *
    ...
    /** Calls
     * {@link CommonsLogMsg#warn(Log, Msg.BundleBaseName, Locale, String, Object[])}
     * to log the message.
     *
    ...
    /** Calls
     * {@link CommonsLogMsg#info(Log, Throwable, Msg.BundleBaseName, Locale, String, Object[])}
     * to log the message.
     *
    ...
    /** Calls
     * {@link CommonsLogMsg#info(Log, Msg.BundleBaseName, Locale, String, Object[])}
     * to log the message.
     *
    ...
    /** Calls
     * {@link CommonsLogMsg#debug(Log, Throwable, Msg.BundleBaseName, Locale, String, Object[])}
     * to log the message.
     *
    ...
    /** Calls
     * {@link CommonsLogMsg#debug(Log, Msg.BundleBaseName, Locale, String, Object[])}
     * to log the message.
     *
    ...
    /** Calls
     * {@link CommonsLogMsg#trace(Log, Throwable, Msg.BundleBaseName, Locale, String, Object[])}
     * to log the message.
     *
    ...
    /** Calls
     * {@link CommonsLogMsg#trace(Log, Msg.BundleBaseName, Locale, String, Object[])}
     * to log the message.
     *

 ...
 * <code>\@I18NResourceBundle</code> - since both can contain static final
 * String constants (this is useful if you want to put all of your I18N message
 * fields in a single interface - thus keeping all I18N information in a single

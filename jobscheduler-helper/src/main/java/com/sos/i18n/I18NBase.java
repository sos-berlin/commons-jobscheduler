 ...
 * \author KB
 * 
 * @version $Id$10.01.2011 \see reference
 *
...
public class I18NBase extends com.sos.JSHelper.Basics.JSToolBox {
    ...
    /*
     * ! \var OUTPUT_CHARSET_NAME \brief We use ISO-8859-1, rather than the
     * JVM's default encoding, as the encoding when writing the resource bundle
     * properties files, since ISO-8859-1 is the encoding Java uses to read
     * resource bundle properties files unless you jump through some major
     * hoops, which we currently do not jump through in {@link
     * com.sos.i18n.Msg#getResourceBundle()}. <p/> Note, for compatibility with
     * older Java runtimes, we use the "historical Java name" for the encoding -
     * "ISO8859_1".
     */
    private static final String OUTPUT_CHARSET_NAME = "ISO-8859-1";
    /*
     * ! \var BUNDLE_BASE_NAME \brief This is the base name of this task's own
     * I18N message bundle.
     */

...
/** \file MissingAppenderException.java \brief Appender ist nicht in
 * Konfigurationsfile vorhanden
 * 
 * \class MissingAppenderException \brief Appender ist nicht in
 * Konfigurationsfile vorhanden
 * 
 * \details Diese Exception wird ausgelöst, wenn ein erwarteter Appender nicht
 * im Konfigurationsfile vorhanden ist.
 *
 * \author EQCPN
 * 

 ...
 * \details
 *
 * <note language="en"> <div xmlns="http://www.w3.org/1999/xhtml"> Specifies the
 * size of one or multiple files in bytes: <br/>
 * Possible Values:<br/>
 * -1 (disabled)<br/>
 * number (Byte), e.g. 40<br/>
 * numberKB, e.g. 5KB (case insensitive)<br/>
 * numberMB, e.g. 20MB (case insensitive)<br/>
 * numberGB, e.g. 10GB (case insensitive) </div> </note>
 *
 *
 * <note language="de"> <div xmlns="http://www.w3.org/1999/xhtml"> Vereinbart
 * die minimale Größe einer oder mehrerer Dateien in Bytes: unterschreitet die
 * Größe einer der Dateien diesen Wert, dann gilt sie als nicht vorhanden.<br/>
 * <br/>
 ...
 * ZahlGB, z.B. 10GB (Groß/Kleinschreibung wird ignoriert) </div> </note>
 * 

...
/** \class JSOptionValueList - Klasse für eine Option mit Einem String-Array als
 * Wertemenge
 *
 * \brief JSOptionValueList - Klasse für eine Option mit Einem String-Array als
 * Wertemenge
 *
 * \details
 *
 * Mit dieser Klasse wird eine Möglichkeit implementiert, eine aufzählbare Menge
 * von Strings in einer Option als Wert zu halten und abzufragen bzw.
 * auszuwerten.
 *
 * \code JSOptionValueList objVL = new JSOptionValueList( objOptions,
 * "ValueList", "Descr", "Das|ist|das|Haus|vom|Nikolaus", "", false);
 * 
 ...
 * System.out.println("klaus ist enthalten: " + objVL.contains("kolaus"));
 * 
 * for (int i = 0; i < objVL.value().length; i++) { System.out.println
 * (String.format("Index %1$d hat den Wert '%2$s'", i, objVL.ElementAt(i))); }
 * \endcode \code 17:04:10 Descr: changed from '' to
 * 'Das|ist|das|Haus|vom|Nikolaus'. Nikolaus ist enthalten: true klaus ist
 * enthalten: false 17:04:10 Descr: changed from 'Das|ist|das|Haus|vom|Nikolaus'
 * to 'Das|ist|das|Haus|vom|Nikolaus'. Nikolaus ist enthalten: true klaus ist
 * enthalten: false Index 0 hat den Wert 'Das' Index 1 hat den Wert 'ist' Index
 * 2 hat den Wert 'das' Index 3 hat den Wert 'Haus' Index 4 hat den Wert 'vom'
 ...
 * \author eqbfd
 * 
 * @version $Id$26.01.2009 \see reference
 *
...
public class JSOptionValueList extends SOSOptionString {
    ...
    /** \brief JSOptionValueList
     *
     * \details Initialisiert das String-Array anhand des IndexedKey IndexedKey
     * ist eine Option in den Settings, die unter diesem Key mehrfach vorkommen
     * kann. Die Keys aller Optionen haben den Aufbau: IndexedKey, IndexedKey1
     * .. IndexedKeyN Lücken im Index sind nicht zugelassen.
     *
     * @param pPobjParent
     * @param pPstrKey
     * @param pPstrDescription
     ...
     *
     * \details Die Methode liefert das n-te Element aus der Liste. Falls der
     * Index ausserhalb des gültigen gültigen Bereichs ist, wird ein leerer
     * String geliefert.
     *
    ...
    /** \brief Value -
     *
     * \details Mit dieser Methode wird ein einzelner Wertestring, bei dem die
     * Einzelwerte durch ";" oder "|" getrennt sind, übergeben.
     *
     * Die Einzelwerte werden in der ValueList (abzurufen über die Methode
     * "value") gespeichert. Der Wertestring bleibt über die Methode "Value"
     * erreichbar.
     *
     * Ein Beispiel: \code objVL.Value("Das|ist|das|Haus|vom|Nikolaus");
     * System.out.println("Nikolaus ist enthalten: " +
     * objVL.contains("Nikolaus")); System.out.println("klaus ist enthalten: " +
     * objVL.contains("kolaus")); \endcode \return
     *
     * @param pstrValueList
     * @throws Exception */
    @Override
     ...
     *
     * \details Diese Methode liefert die ValueList als StringArray.
     *
     * Ein Beispiel: \code for (int i = 0; i < objVL.value().length; i++) {
     * System.out.println (String.format("Index %1$d hat den Wert '%2$s'", i,
     * objVL.ElementAt(i))); } \endcode
     *
     ...
     *
     * \details Einzelne Strings mit angegebenen Delimiter verbinden.
     *
     * \return String
     *
     * @param pstrDelimiter
    ...
    /** \change Freitag, 8. Mai 2009 EQALS MehrereExportSQL Mehr als ExportSQLs
     * verarbeiten können */
    // - <newcode>
    ...
    /** \brief contains
     *
     * \details Mit dieser Methode wird geprüft, ob in der ValueList ein
     * bestimmter, als Parameter anzugebender, String enthalten ist.
     *
     * Der String wird im Ganzen verglichen. Reguläre Ausdrücke sind nicht
     * vorgesehen.
     *
     * Es wird nicht zwischen Groß- und Kleinschreibung unterschieden. Ein
     * Beispiel: \code objVL.Value("Das|ist|das|Haus|vom|Nikolaus");
     * System.out.println("Nikolaus ist enthalten: " +
     * objVL.contains("Nikolaus")); System.out.println("klaus ist enthalten: " +
     * objVL.contains("kolaus")); \endcode
     *
     * \return boolean
     *
     ...
     *
     * \details Der Index eines anzugebenden Wertes wird zurückgegeben. Ist der
     * Wert nicht in der ValueList enthalten, so wird -1 zurückgegeben.
     *
     * Es wird nicht zwischen Groß- und Kleinschreibung unterschieden. \return
     * int - Index oder -1
     *
     * @param pstrValue2Find */

...
public class SOSOptionBoolean extends SOSOptionElement {
    ...
    public void Value(final String pstrValue) {
        if (isNotEmpty(pstrValue)) {
            /** \todo über den regexp prüfen, ob die Werte syntaktisch korrekt
             * sind */
    ...
    /** \brief isTrue
     *
     * \details returns true, if the value of this option is "true".
     *
     * \return boolean \see isFalse()
     *
     * @return */
    ...
    /** \brief isFalse
     *
     * \details returns "true", if the value of this option is "false".
     *
     * \return boolean \see isTrue()
     *
     * @return */

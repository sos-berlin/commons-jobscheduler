 ...
 * minimum age of one or multiple files. If the files is newer then it is
 * classified as non-existing.<br/>
 * <br/>
 * Possible values:<br/>
 * 0 (disabled)<br/>
 * seconds<br/>
 * hours:minutes<br/>
 * hours:minutes:seconds </div> </note>
 * 
 * <note language="de"> <div xmlns="http://www.w3.org/1999/xhtml"> Vereinbart
 * das Mindestalter einer oder mehrerer Dateien. Ist eine Datei jünger, dann
 * gilt sie als nicht vorhanden.<br/>
 * <br/>
 * Mögliche Werte sind:<br/>
 * 0 (parameter wird ignoriert)<br/>
 * Sekunden<br/>
 * Stunden:Minuten<br/>
 * Stunden:Minuten:Sekunden </div> </note>
 * 

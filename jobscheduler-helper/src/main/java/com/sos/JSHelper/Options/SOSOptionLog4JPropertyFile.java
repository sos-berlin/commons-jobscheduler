...
public class SOSOptionLog4JPropertyFile extends SOSOptionInFileName {
    ...
    private static final Logger LOGGER = LogManager.getLogger(SOSOptionLog4JPropertyFile.class);
...
//            flgPropFileIsOk = true;
//        }
//        objRootLog = LogManager.getRootLogger();
//        if (flgPropFileIsOk) {
...
//                AbstractAppender consoleAppender = null;
//                if (flgUseJobSchedulerLog4JAppender == true && objLoggingAppender != null) {
//                    if (objLoggingAppender instanceof AbstractAppender) {
//                        consoleAppender = (AbstractAppender) objLoggingAppender;
...
//        } else {
//            objCurrentLog = LogManager.getLogger(strParentClassName);
//        }
//        if (flgNew) {

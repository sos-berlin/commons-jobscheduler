 ...
 * \author eqbfd
 * 
 * @version $Id$16.06.2009 \see reference
 *
...
public class JSDataElementTimeStampISO extends JSDataElementDate {
    ...
    public String FormattedValue() {
        ...
        try {
            ...
            /** Original-Wert zurücliefern, wenn es nicht konvertiert werden
             * kann. */
        }
    ...
    public String ValueISO() throws Exception {
        ...
        try {
            ...
            throw new FormatPatternException(conMethodName + ": the value '" + this.Value() + "' does not correspond with the pattern "

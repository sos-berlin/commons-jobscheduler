...
public class JSDataElementDouble extends JSDataElementNumeric {
    ...
    public void doInit() {
        ...
        // >
        /** \change Donnerstag, 11. Juni 2009 EQALS Korrektur Korrektur
         * Initialisierung FormatString Keine 1000er Gruppierung 3
         * Nachkommstellen */
        // - <oldcode>
        // super.FormatString(",15.2f"); // minus weggelassen, weil steht für
        // "left justi"
        // - </oldcode>
        // - <newcode>
        super.FormatString("15.3f");  // minus weggelassen, weil steht für
                                     // "left justi"
        // - </newcode>
        // - </remark> <!-- id=<Korrektur> -->
    ...
    /** \change Donnerstag, 5. März 2009 EQCPN FORM Konvertierung verschiedener
     * Zahlenformate */
    ...
    // //- </oldcode>
    // //- <newcode>
    // // Zunächst wird versucht die Zahl nach deutschem Format zu
    // interpretieren (das , ist
    // // Dezimaltrennzeichen, der . für die Tausender. Klappt das nicht
    // versuchen wir es mit
    // // dem amerikanischen Format.
    // try {
    // Number number =
    // NumberFormat.getNumberInstance(Locale.GERMAN).parse(strT);
    // dblValue = (number instanceof Double) ? (Double) number : new
    // Double(this.Value());
    ...
    public String FormattedValue() {
        ...
        // System.out.println("JSDataElementDouble.FormattedValue()" +
        // Decimal());
        //
        ...
        if (isNotEmpty(strFormat)) {
            ...
            // TODO aktueller und zu verwendender Dezimalpunkt nicht fest,
            // sondern dynamisch. 1000er Trennzeichen nicht sinnvoll?
    ...
    /** \brief Value
     *
     * \details Hier werden evtl. vorhandene Tausenderpunkte/Kommas oder dergl.
     * rausgefiltert und es wird eine einheitliche Zahl erzeugt. \return
     *
     * @param pstrValue */
    @Override

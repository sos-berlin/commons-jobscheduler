 ...
 * (http://www.sos-berlin.com) ######### 2007-11-26, kb@sos-berlin.com (sgx2343)
 * --
 * -----------------------------------------------------------------------------
 * <docu type="smcw" version="1.0"> <project>sos.dataswitch</project>
 * <name>JSExceptionMandatoryOptionMissing.java</name> <title>Exception used if
 * a mandatory Option is not specified </title> <description> <para> Exception
 * used if a mandatory Option is not specified </para> </description> <params>
 * </params> <keywords> <keyword>Exception</keyword> <keyword>Option</keyword>
 * </keywords> <categories> <category>Exception</category> </categories>
 * <date>2007-11-26</date> <copyright>© 2006 by Klaus D. Buettner</copyright>
 * <author>kb@sos-berlin.com</author> <changes> <change who='sgx2343'
 * when='2007-11-26' id='created'> <what> <para> created </para> </what>
 * </change> </changes> </docu>
 * ----------------------------------------------------------------------------
 */
/*
 ...
 * @brief Exception used if a mandatory Option is not specified ... more details

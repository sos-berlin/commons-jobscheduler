...
public class JSArchiver extends JSListenerClass {
    ...
    public void Archive() throws Exception {
        ...
        if (objOptions.CompressArchivedFile()) {
            ...
            // TODO: entweder als "eigenen" File ablegen oder in ein bestehendes
            // ZIP-File integrieren.
        ...
        if (objOptions.CreateTimeStamp()) {
            /*
             * hier muß gelöscht werden, da der die Datei mit dem
             * Time-Stamp-Namen auch noch im Source-Verzeichnis liegt. Und hier
             * muß diese weg.
             */

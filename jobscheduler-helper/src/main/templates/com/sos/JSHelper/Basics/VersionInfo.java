...
public class VersionInfo {
    ...
    public final static String BUILD_YEAR = "${build.year}";
    
    public final static String VERSION_STRING = JAR_VERSION + " (" + TIME_STAMP + ", revision " + SVN_REVISION + ") Copyright 2003-" + BUILD_YEAR + " SOS GmbH Berlin";

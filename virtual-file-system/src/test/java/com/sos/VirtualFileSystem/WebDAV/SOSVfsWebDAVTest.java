...
public class SOSVfsWebDAVTest {
     ...
     * 
     *       objOptions.host.Value(WEB_URI); objOptions.port.value(0);
     * 
     *       SOSConnection2OptionsAlternate objSource =
     *       objOptions.getConnectionOptions().Source();
     *       objSource.host.Value(WEB_URI); objSource.user.Value(WEB_USER);
     * 
    ...
    /** @Test public void testAuthenticate() throws Exception { connect();

...
public class SOSVfsHTTPTest {
    ...
    public void testSize() throws Exception {
        ...
        // System.out.println(objVfsClient.getFileSize(REMOTE_BASE_PATH +
        // "sos-net-src.zip"));
        // System.out.println(objVfsClient.getFileSize(REMOTE_BASE_PATH +
        // "BVG.pdf"));
    ...
    public void testPut() throws RuntimeException, Exception {
        connect();
        authenticate();
        // objVfsClient.putFile(LOCAL_BASE_PATH + "sos-net-src.zip",
        // REMOTE_BASE_PATH + "sos-net-src.zip");
    ...
    public void testPutFileStringOutputStream() throws Exception {
        ...
        /** OutputStream out = objVfsClient.getOutputStream(REMOTE_BASE_PATH +
         * "out.test.txt"); out.write("hallo".getBytes()); out.flush();
         * out.close(); */
    ...
    public void testDelete() throws Exception {
        ...
        // objVfsClient.put(LOCAL_BASE_PATH + "sos-net-src.zip",
        // REMOTE_BASE_PATH + "tmp123.zip");
    ...
    public void testRename() throws Exception {
        ...
        // objVfsClient.put(LOCAL_BASE_PATH + "sos-net-src.zip",
        // REMOTE_BASE_PATH + "tmp123.zip");
        // 7objVfsClient.rename(REMOTE_BASE_PATH + "tmp123.zip",
        // REMOTE_BASE_PATH + "tmp1234.zip");

...
/** \class SOSConnection2OptionsJUnitTest - Options for a connection to an uri
 * (server, site, e.g.)
 *
 * \brief
 *
 ...
 * http://www.sos-berlin.com at 20100917112411 \endverbatim
 *
 ...
 * ("		SOSConnection2OptionsJUnitTest.auth_file", "test"); // This parameter
...
public class SOSConnection2OptionsJUnitTest extends JSToolBox {
    ...
    /** \brief testpassive_mode : passive_mode Passive mode for FTP is often used
     * wit
     *
    ...
    public void testKeyWithPrefix() throws Exception {
        ...
        // assertEquals("jump_host failed", "test6",
        // objOptions.JumpServer().host.Value());
    }

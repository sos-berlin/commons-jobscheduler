/*
 * ftp4j - A pure Java FTP client library Copyright (C) 2008-2010 Carlo Pelliccia (www.sauronsoftware.it) This program is free software: you can redistribute it
 * and/or modify it under the terms of the GNU Lesser General Public License version 2.1, as published by the Free Software Foundation. This program is
 ...
 * PURPOSE. See the GNU Lesser General Public License 2.1 for more details. You should have received a copy of the GNU Lesser General Public License version 2.1

...
public class VFSFactory extends SOSVfsMessageCodes {
    ...
    // public static String sFTPHandlerClassName =
    // "com.sos.VirtualFileSystem.SFTP.SOSVfsSFtp";
    // TODO change default data provider for sftp to
    // com.sos.VirtualFileSystem.SFTP.SOSVfsSFtpFileJCraft
    ...
    /*
     * ! \var SOSVfs_D_0201 \brief %1$s returns instance of %2$s
     */
    /*
     * ! \var SOSVfs_E_0203 \brief Msgundefined Virtual File System requested:
     * %1$s
     */
    ...
    public static ISOSVFSHandler getHandler(String pstrWhatURL) throws Exception {
        ...
        // | user
        // protocol
        /** The url object of java provides URLs with a single slash like
         * file:/path/to/file (not file://path/to/file) therefore the presence
         * of "//" is not significant to test an URL */
        ...
        if (strWhatSystem.equalsIgnoreCase(SOSOptionTransferType.enuTransferTypes.ssh2.Text())) {
            // TODO über late binding laden, damit es auch als Option verwendet
            // werden kann
            // com.sos.VirtualFileSystem.SSH.SOSSSH2TriLeadImpl
            // objC = new SOSSSH2TriLeadImpl();
            // logger.debug(conMethodName + " returns instance of " +
            // SOSSSH2TriLeadImpl.class.toString());
            // com.sos.VirtualFileSystem.SSH.SOSSSH2GanymedImpl
            // objC = new SOSSSH2GanymedImpl();
            // logger.debug(conMethodName + " returns instance of " +
            // SOSSSH2GanymedImpl.class.toString());
            // Class objA =
            // classLoader.loadClass("com.sos.VirtualFileSystem.SSH.SOSSSH2GanymedImpl");

            // Class objA =
            // classLoader.loadClass("com.sos.VirtualFileSystem.SSH.SOSSSH2TriLeadImpl");
            Class objA;
            if (useTrilead) {
        ...
        if (strWhatSystem.equalsIgnoreCase(SOSOptionTransferType.enuTransferTypes.ftp.Text())) {
            ...
            // objC = new SOSVfsFtp();
            // logger.debug(String.format(objMsg.getMsg(SOSVfs_D_0201),
            // conMethodName, SOSVfsFtp.class.toString()));
        }
        ...
        if (strWhatSystem.equalsIgnoreCase(SOSOptionTransferType.enuTransferTypes.sftp.Text())) {
            // objC =
            // getDynamicVFSHandler("com.sos.VirtualFileSystem.SFTP.SOSVfsSFtpJCraft");

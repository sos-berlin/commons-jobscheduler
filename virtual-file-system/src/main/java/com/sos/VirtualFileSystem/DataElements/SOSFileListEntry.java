...
public class SOSFileListEntry extends SOSVfsMessageCodes implements Runnable, IJadeTransferDetailHistoryData {
    ...
    private String replaceVariables(final String value) {
        ...
        EntryPaths targetFile = new EntryPaths(objOptions.TargetDir.Value(), resolveDotsInPath(MakeFullPathName(objOptions.TargetDir.Value(),
                strTargetFileName)));
        EntryPaths targetTransferFile = new EntryPaths(objOptions.TargetDir.Value(), resolveDotsInPath(MakeFullPathName(objOptions.TargetDir.Value(),
                strTargetTransferName)));

        EntryPaths sourceFile = new EntryPaths(objOptions.SourceDir.Value(), resolveDotsInPath(strSourceFileName));
        EntryPaths sourceFileRenamed = new EntryPaths(objOptions.SourceDir.Value(), strRenamedSourceFileName);

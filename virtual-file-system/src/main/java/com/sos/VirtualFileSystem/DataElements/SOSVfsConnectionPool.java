...
public class SOSVfsConnectionPool {
	...
	*
	* \details
	* Returns the list of the current instances of connections
	*
	...
	*
	* \details
	* returns the next unused (idle) connection from the pool.
	* Checks the connection status and (re)connect, if needed.
	* Checks the credentials and make a (re)authentication, if needed.
	* Set a lock to avoid duplicate usage.
	*

...
public class SOSVfsCsvExport extends SOSVfsMessageCodes implements ISOSTransferHistory {
	...
	@Override public void doTransferDetail() {
		@SuppressWarnings("unused") final String conMethodName = conClassName + "::doExportDetail";
		if (objCSVFile == null) {
	 ...
	 */
	@Override public void setData(final SOSFTPOptions pobjTransferHistoryData) {

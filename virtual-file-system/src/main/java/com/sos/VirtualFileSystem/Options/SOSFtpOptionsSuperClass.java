...
public abstract class SOSFtpOptionsSuperClass extends JSOptionsClass implements ISOSConnectionOptions, ISOSAuthenticationOptions, ISOSFtpOptions {
    ...
    public SOSOptionBoolean useFilters = new SOSOptionBoolean(this, CLASS_NAME + ".use_filters", "Use filters for source and/or Targe", "false",
            "false", false);
    ...
    public SOSOptionBoolean isFragment = new SOSOptionBoolean(this, CLASS_NAME + ".is_fragment", "Mark an profile as a fragment", "false", "false",
            false);
    ...
    public SOSOptionBoolean reuseConnection = new SOSOptionBoolean(this, CLASS_NAME + ".reuse_connection",
    ...
    public SOSOptionPlatform platform = new SOSOptionPlatform(this, CLASS_NAME + ".platform", "platform on which the app is running", "", "", false);
    ...
    public SOSOptionString title = new SOSOptionString(this, CLASS_NAME + ".title", "The Title for a section /profile", "", "", false);
    ...
    public SOSOptionCommandString postCommand = new SOSOptionCommandString(this, CLASS_NAME + ".Post_Command",
    ...
    public SOSOptionCommandString preCommand = new SOSOptionCommandString(this, CLASS_NAME + ".Pre_Command", "", "", "", false);
    ...
    public SOSOptionCommandString preFtpCommands = new SOSOptionCommandString(this, CLASS_NAME + ".Pre_Ftp_Commands",
    ...
    public SOSOptionBoolean decompressAfterTransfer = new SOSOptionBoolean(this, CLASS_NAME + ".Decompress_After_Transfer",
    ...
    public void setCreateOrder(final SOSOptionBoolean val) {
        createOrder = val;
    }
    ...
    public void setCreateOrdersForAllFiles(final SOSOptionBoolean val) {
        createOrdersForAllFiles = val;
    }
    ...
    public void setCreateOrdersForNewFiles(final SOSOptionBoolean val) {
        createOrdersForNewFiles = val;
    }
    ...
    public void getParamNameForPath(final SOSOptionString val) {
        paramNameForPath = val;
    }
    ...
    public void setExpectedSizeOfResultSet(final SOSOptionInteger val) {
        expectedSizeOfResultSet = val;
    }
    ...
    public SOSOptionFileName file = new SOSOptionFileName(this, CLASS_NAME + ".file",
    ...
    public SOSOptionFileName target = new SOSOptionFileName(this, CLASS_NAME + ".target",
    ...
    public SOSOptionFileName FileName = (SOSOptionFileName) file.setAlias(CLASS_NAME + ".FileName");
    ...
    public void setMaxFileAge(final SOSOptionTime val) {
        maxFileAge = val;
    }
    ...
    public void setMaxFileSize(final SOSOptionFileSize val) {
        maxFileSize = val;
    }
    ...
    public void setMinFileAge(final SOSOptionTime val) {
        minFileAge = val;
    }
    ...
    public void setMinFileSize(final SOSOptionFileSize val) {
        minFileSize = val;
    }
    ...
    public void setNextState(final SOSOptionJobChainNode val) {
        nextState = val;
    }
    ...
    public void setOnEmptyResultSet(final SOSOptionJobChainNode val) {
        onEmptyResultSet = val;
    }
    ...
    public void setOrderJobschedulerHost(final SOSOptionHostName val) {
        orderJobschedulerHost = val;
    }
    ...
    public void setOrderJobschedulerPort(final SOSOptionPortNumber val) {
        orderJobschedulerPort = val;
    }
    ...
    public void setOrderJobchainName(final SOSOptionString val) {
        orderJobchainName = val;
    }
    ...
    public void setRaiseErrorIfResultSetIs(final SOSOptionRelOp val) {
        raiseErrorIfResultSetIs = val;
    }
    ...
    public void setResultListFile(final SOSOptionFileName val) {
        resultListFile = val;
    }
    ...
    public void setSchedulerFileName(final SOSOptionFileName val) {
        schedulerFileName = val;
    }
    ...
    public void setSchedulerFileParent(final SOSOptionFileName val) {
        schedulerFileParent = val;
    }
    ...
    public void setSchedulerFilePath(final SOSOptionFileName val) {
        schedulerFilePath = val;
    }
    ...
    public void setSchedulerSosFileOperationsResultsetSize(final SOSOptionInteger val) {
        schedulerSosFileOperationsResultsetSize = val;
    }
    ...
    public void setSkipFirstFiles(final SOSOptionInteger val) {
        skipFirstFiles = val;
    }
    ...
    public void setSkipLastFiles(final SOSOptionInteger val) {
        skipLastFiles = val;
    }
    ...
    public SOSOptionString alternativeAccount = new SOSOptionString(this, CLASS_NAME + ".alternative_account",
    ...
    @Override
    public void setAlternativeAccount(final SOSOptionString val) {
        alternativeAccount = val;
    }
    ...
    public SOSOptionHostName alternativeHost = new SOSOptionHostName(this, CLASS_NAME + ".alternative_host",
            "Alternative parameter for the primary parameter", "", "", false);
    ...
    public SOSOptionString alternativePassiveMode = new SOSOptionString(this, CLASS_NAME + ".alternative_passive_mode",
            "Alternative parameter for the primary parameter", "", "", false);
    ...
    @Override
    public void setAlternativePassiveMode(final SOSOptionString val) {
        alternativePassiveMode = val;
    }
    ...
    public SOSOptionPassword alternativePassword = new SOSOptionPassword(this, CLASS_NAME + ".alternative_password",
            "Alternative parameter for the primary parameter", "", "", false);
    ...
    public SOSOptionPortNumber alternativePort = new SOSOptionPortNumber(this, CLASS_NAME + ".alternative_port",
    ...
    @Override
    public void setAlternativePort(final SOSOptionPortNumber val) {
        alternativePort = val;
    }

    public SOSOptionPortNumber AlternativePortNumber = (SOSOptionPortNumber) alternativePort.setAlias(CLASS_NAME + ".AlternativePortNumber");
    ...
    public SOSOptionString alternativeRemoteDir = new SOSOptionString(this, CLASS_NAME + ".alternative_remote_dir",
            "Alternative parameter for the primary parameter", "", "", false);
    ...
    @Override
    public void setAlternativeRemoteDir(final SOSOptionString val) {
        alternativeRemoteDir = val;
    }
    ...
    public SOSOptionString alternativeTransferMode = new SOSOptionString(this, CLASS_NAME + ".alternative_transfer_mode",
            "Alternative parameter for the primary parameter", "", "", false);
    ...
    @Override
    public void setAlternativeTransferMode(final SOSOptionString val) {
        alternativeTransferMode = val;
    }
    ...
    public SOSOptionUserName alternativeUser = new SOSOptionUserName(this, CLASS_NAME + ".alternative_user",
            "Alternative parameter for the primary parameter", "", "", false);
    ...
    @Override
    public void setAlternativeUser(final SOSOptionUserName val) {
        alternativeUser = val;
    }
    ...
    @Override
    public void setAppendFiles(final SOSOptionBoolean val) {
        appendFiles = val;
    }
    ...
    @Override
    public void setAtomicPrefix(final SOSOptionString val) {
        atomicPrefix = val;
    }
    ...
    @Override
    public void setAtomicSuffix(final SOSOptionString val) {
        atomicSuffix = val;
    }
    ...
    @Override
    public void setBannerFooter(final SOSOptionInFileName val) {
        bannerFooter = val;
    }
    ...
    @Override
    public void setBannerHeader(final SOSOptionInFileName val) {
        bannerHeader = val;
    }
    ...
    @Override
    public void setCheckInterval(final SOSOptionInteger val) {
        checkInterval = val;
    }
    ...
    @Override
    public void setCheckRetry(final SOSOptionInteger val) {
        checkRetry = val;
    }
    ...
    public SOSOptionFolderName classpathBase = new SOSOptionFolderName(this, CLASS_NAME + ".classpath_base",
    ...
    @Override
    public void setClasspathBase(final SOSOptionFolderName val) {
        classpathBase = val;
    }
    ...
    public SOSOptionProcessID currentPid = new SOSOptionProcessID(this, CLASS_NAME + ".current_pid",
    ...
    @Override
    public void setCurrentPid(final SOSOptionProcessID val) {
        currentPid = val;
    }
    ...
    @Override
    public void setFilePath(final SOSOptionFileName val) {
        filePath = val;
    }
    ...
    @Override
    public void setFileSpec(final SOSOptionRegExp val) {
        fileSpec = val;
    }
    ...
    @Override
    public void setForceFiles(final SOSOptionBoolean val) {
        forceFiles = val;
    }
    ...
    public SOSOptionInteger historyRepeat = new SOSOptionInteger(this, CLASS_NAME + ".history_repeat",
    ...
    @Override
    public void setHistoryRepeat(final SOSOptionInteger val) {
        historyRepeat = val;
    }
    ...
    public SOSOptionInteger historyRepeatInterval = new SOSOptionInteger(this, CLASS_NAME + ".history_repeat_interval",
    ...
    @Override
    public void setHistoryRepeatInterval(final SOSOptionInteger val) {
        historyRepeatInterval = val;
    }
    ...
    public SOSOptionString httpProxyHost = new SOSOptionString(this, CLASS_NAME + ".http_proxy_host",
    ...
    @Override
    public void setHttpProxyHost(final SOSOptionString val) {
        httpProxyHost = val;
    }
    ...
    public SOSOptionString httpProxyPort = new SOSOptionString(this, CLASS_NAME + ".http_proxy_port",
    ...
    @Override
    public void setHttpProxyPort(final SOSOptionString val) {
        httpProxyPort = val;
    }
    ...
    @Override
    public void setJumpCommand(final SOSOptionString val) {
        jumpCommand = val;
    }
    ...
    @Override
    public void setJumpCommandDelimiter(final SOSOptionString val) {
        jumpCommandDelimiter = val;
    }
    ...
    @Override
    public void setJumpCommandScript(final SOSOptionCommandScript val) {
        jumpCommandScript = val;
    }
    ...
    @Override
    public void setJumpCommandScriptFile(final SOSOptionCommandScriptFile val) {
        jumpCommandScriptFile = val;
    }
    ...
    @Override
    public void setJumpHost(final SOSOptionHostName val) {
        jumpHost = val;
    }
    ...
    public SOSOptionBoolean jumpIgnoreError = new SOSOptionBoolean(this, CLASS_NAME + ".jump_ignore_error",
    ...
    @Override
    public void setJumpIgnoreError(final SOSOptionBoolean val) {
        jumpIgnoreError = val;
    }
    ...
    public SOSOptionBoolean jumpIgnoreSignal = new SOSOptionBoolean(this, CLASS_NAME + ".jump_ignore_signal", "Should the value true be specified, t",
            "false", "false", false);
    ...
    @Override
    public void setJumpIgnoreSignal(final SOSOptionBoolean val) {
        jumpIgnoreSignal = val;
    }
    ...
    public SOSOptionBoolean jumpIgnoreStderr = new SOSOptionBoolean(this, CLASS_NAME + ".jump_ignore_stderr",
    ...
    @Override
    public void setJumpIgnoreStderr(final SOSOptionBoolean val) {
        jumpIgnoreStderr = val;
    }
    ...
    @Override
    public void setJumpPassword(final SOSOptionPassword val) {
        jumpPassword = val;
    }
    ...
    @Override
    public void setJumpPort(final SOSOptionPortNumber val) {
        jumpPort = val;
    }
    ...
    @Override
    public void setJumpProtocol(final SOSOptionString val) {
        jumpProtocol = val;
    }
    ...
    @Override
    public void setJumpProxyHost(final SOSOptionString val) {
        jumpProxyHost = val;
    }
    ...
    @Override
    public void setJumpProxyPassword(final SOSOptionString val) {
        jumpProxyPassword = val;
    }
    ...
    @Override
    public void setJumpProxyPort(final SOSOptionString val) {
        jumpProxyPort = val;
    }
    ...
    @Override
    public void setJumpProxyUser(final SOSOptionUserName val) {
        jumpProxyUser = val;
    }
    ...
    public SOSOptionBoolean jumpSimulateShell = new SOSOptionBoolean(this, CLASS_NAME + ".jump_simulate_shell",
    ...
    @Override
    public void setJumpSimulateShell(final SOSOptionBoolean val) {
        jumpSimulateShell = val;
    }
    ...
    public SOSOptionInteger jumpSimulateShellInactivityTimeout = new SOSOptionInteger(this, CLASS_NAME + ".jump_simulate_shell_inactivity_timeout",
    ...
    @Override
    public void setJumpSimulateShellInactivityTimeout(final SOSOptionInteger val) {
        jumpSimulateShellInactivityTimeout = val;
    }
    ...
    public SOSOptionInteger jumpSimulateShellLoginTimeout = new SOSOptionInteger(this, CLASS_NAME + ".jump_simulate_shell_login_timeout",
            "If no new characters are written to stdout or stde", "", "", false);
    ...
    @Override
    public void setJumpSimulateShellLoginTimeout(final SOSOptionInteger val) {
        jumpSimulateShellLoginTimeout = val;
    }
    ...
    public SOSOptionString jumpSimulateShellPromptTrigger = new SOSOptionString(this, CLASS_NAME + ".jump_simulate_shell_prompt_trigger",
    ...
    @Override
    public void setJumpSimulateShellPromptTrigger(final SOSOptionString val) {
        jumpSimulateShellPromptTrigger = val;
    }
    ...
    @Override
    public void setJumpSshAuthFile(final SOSOptionInFileName val) {
        jumpSshAuthFile = val;
    }
    ...
    @Override
    public void setJumpSshAuthMethod(final SOSOptionAuthenticationMethod val) {
        jumpSshAuthMethod = val;
    }
    ...
    @Override
    public void setJumpUser(final SOSOptionUserName val) {
        jumpUser = val;
    }
    ...
    public void setJumpStrictHostKeyChecking(final String val) {
        jumpStrictHostkeyChecking.setValue(val);
    }
    ...
    public void setJumpConfigurationFiles(SOSOptionString val) {
        jumpConfigurationFiles = val;
    }
    ...
    @Override
    public void setLocalDir(final SOSOptionFolderName val) {
        localDir = val;
    }
    ...
    @Override
    public void setOverwriteFiles(final SOSOptionBoolean val) {
        overwriteFiles = val;
    }
    ...
    public void setJumpPreCommand(SOSOptionCommandString val) {
        jumpPreCommand = val;
    }
    ...
    public void setJumpPostCommandOnSuccess(SOSOptionCommandString val) {
        jumpPostCommandOnSuccess = val;
    }
    ...
    public void setJumpPreTransferCommands(SOSOptionCommandString val) {
        jumpPreTransferCommands = val;
    }
    ...
    public void setJumpPostTransferCommandsOnSuccess(SOSOptionCommandString val) {
        jumpPostTransferCommandsOnSuccess = val;
    }
    ...
    public void setJumpPostTransferCommandsOnError(SOSOptionCommandString val) {
        jumpPostTransferCommandsOnError = val;
    }
    ...
    public void setJumpPostTransferCommandsFinal(SOSOptionCommandString val) {
        jumpPostTransferCommandsFinal = val;
    }
    ...
    @Override
    public void setPollInterval(final SOSOptionTime val) {
        pollInterval = val;
    }
    ...
    @Override
    public void setPollMinfiles(final SOSOptionInteger val) {
        pollMinfiles = val;
    }
    ...
    @Override
    public void setPollTimeout(final SOSOptionInteger val) {
        pollTimeout = val;
    }
    ...
    public SOSOptionProcessID ppid = new SOSOptionProcessID(this, CLASS_NAME + ".ppid", "This parameter is used for Unix systems and - as o", "", "",
            false);
    ...
    public SOSOptionProcessID ParentProcessID = (SOSOptionProcessID) ppid.setAlias(CLASS_NAME + ".ParentProcessID");
    ...
    @Override
    public void setRemoteDir(final SOSOptionFolderName val) {
        remoteDir = val;
    }
    ...
    @Override
    public void setRemoveFiles(final SOSOptionBoolean val) {
        removeFiles = val;
    }
    ...
    public SOSOptionFolderName root = new SOSOptionFolderName(this, CLASS_NAME + ".root", "The parameter specifies the directory in which thi", "",
            "", false);
    ...
    public SOSOptionFolderName tempFolderName = (SOSOptionFolderName) root.setAlias(CLASS_NAME + ".TempFolderName");
    ...
    @Override
    public void setSchedulerHost(final SOSOptionHostName val) {
        schedulerHost = val;
    }
    ...
    @Override
    public void setSchedulerJobChain(final JSJobChain val) {
        schedulerJobChain = val;
    }
    ...
    @Override
    public void setSchedulerPort(final SOSOptionPortNumber val) {
        schedulerPort = val;
    }
    ...
    @Override
    public void setSkipTransfer(final SOSOptionBoolean val) {
        skipTransfer = val;
    }
    ...
    @Override
    public void setSshAuthFile(final SOSOptionInFileName val) {
        sshAuthFile = val;
    }
    ...
    @Override
    public void setSshAuthMethod(final SOSOptionAuthenticationMethod val) {
        sshAuthMethod = val;
    }
    ...
    public SOSOptionString sshProxyHost = new SOSOptionString(this, CLASS_NAME + ".ssh_proxy_host",
            "The value of this parameter is the host name or th", "", "", false);
    ...
    @Override
    public void setSshProxyHost(final SOSOptionString val) {
        sshProxyHost = val;
    }
    ...
    public SOSOptionString sshProxyPassword = new SOSOptionString(this, CLASS_NAME + ".ssh_proxy_password",
            "This parameter specifies the password for the prox", "", "", false);
    ...
    @Override
    public void setSshProxyPassword(final SOSOptionString val) {
        sshProxyPassword = val;
    }
    ...
    public SOSOptionString sshProxyPort = new SOSOptionString(this, CLASS_NAME + ".ssh_proxy_port",
    ...
    @Override
    public void setSshProxyPort(final SOSOptionString val) {
        sshProxyPort = val;
    }
    ...
    public SOSOptionString sshProxyUser = new SOSOptionString(this, CLASS_NAME + ".ssh_proxy_user",
            "The value of this parameter specifies the user acc", "", "", false);
    ...
    @Override
    public void setSshProxyUser(final SOSOptionString val) {
        sshProxyUser = val;
    }
    ...
    @Override
    public void setFileSpec2(final SOSOptionRegExp val) {
        //
    }
    ...
    public void setUpdateConfiguration(SOSOptionBoolean val) {
    ...
    public void setXmlUpdate(SOSOptionString val) {
        xmlUpdate = val;
    }

 ...
 * http://www.sos-berlin.com at 2010-05-15-14-28-00 \endverbatim \section
 ...
 * ("		SOSFtpOptionsSuperClass.auth_file", "test"); // This parameter specifies
...
public abstract class SOSFtpOptionsSuperClass extends JSOptionsClass implements ISOSConnectionOptions, ISOSAuthenticationOptions, ISOSFtpOptions {
    ...
    // SOSFtp-191 Option TFN_Post_Command: commands executed after creating the
    // final TargetFile
    /** \option TFN_Post_Command \type SOSOptionString \brief TFN_Post_Command -
     * Post commands executed after creating the final TargetFile
     *
     * \details Post commands after creating the final TargetFileName
     *
     * \mandatory: false
     *
    ...
    /** \option polling_wait_4_Source_Folder \type SOSOptionBoolean \brief
     * polling_wait_4_Source_Folder - Wait for source folder if the folder does
     * not exists
     *
     * \details During polling
     *
     * \mandatory: true
     *
    ...
    public String getPollingWait4SourceFolder() {
        @SuppressWarnings("unused")
        final String conMethodName = conClassName + "::getpolling_wait_4_Source_Folder";
    ...
    public SOSFtpOptionsSuperClass setPollingWait4SourceFolder(final String pstrValue) {
        @SuppressWarnings("unused")
        final String conMethodName = conClassName + "::setpolling_wait_4_Source_Folder";
        pollingWait4SourceFolder.Value(pstrValue);
        return this;
    } // public SOSFtpOptionsSuperClass setpolling_wait_4_Source_Folder

    /** \option include \type SOSOptionString \brief include - the include
     * directive as an option
     *
     * \details the include directive as an option
     *
     * \mandatory: false
     *
    ...
    /** \option use_filters \type SOSOptionBoolean \brief use_filters - Use
     * filters for source and/or Targe
     *
     * \details Use filters for source and/or Targe
     *
     * \mandatory: false
     *
    ...
    public SOSOptionBoolean getuse_filters() {
        @SuppressWarnings("unused")
        final String conMethodName = conClassName + "::getuse_filters";
        return use_filters;
    } // public String getuse_filters

    public SOSFtpOptionsSuperClass setuse_filters(final SOSOptionBoolean pstrValue) {
        @SuppressWarnings("unused")
        final String conMethodName = conClassName + "::setuse_filters";
        use_filters = pstrValue;
        return this;
    } // public SOSFtpOptionsSuperClass setuse_filters

    /** \option is_fragment \type SOSOptionBoolean \brief is_fragment - Mark a
     * profile as an fragment (include snippet)
     *
     * \details Mark an profile as a fragment
     *
     * \mandatory: false
     *
    ...
    public String getis_fragment() {
        @SuppressWarnings("unused")
        final String conMethodName = conClassName + "::getis_fragment";
        return isFragment.Value();
    } // public String getis_fragment

    public SOSFtpOptionsSuperClass setis_fragment(final String pstrValue) {
        @SuppressWarnings("unused")
        final String conMethodName = conClassName + "::setis_fragment";
        isFragment.Value(pstrValue);
        return this;
    } // public SOSFtpOptionsSuperClass setis_fragment

    /** \option reuse_connection \type SOSOptionBoolean \brief reuse_connection -
     * reuse the current connections for all transfers
     *
     * \details reuse the current connections for all transfers
     *
     * \mandatory: false
     *
    ...
    public String getreuse_connection() {
        @SuppressWarnings("unused")
        final String conMethodName = conClassName + "::getreuse_connection";
        return reuseConnection.Value();
    } // public String getreuse_connection

    public SOSFtpOptionsSuperClass setreuse_connection(final String pstrValue) {
        @SuppressWarnings("unused")
        final String conMethodName = conClassName + "::setreuse_connection";
        reuseConnection.Value(pstrValue);
        return this;
    } // public SOSFtpOptionsSuperClass setreuse_connection

    /** \option polling_server \type SOSOptionBoolean \brief polling_server - act
     * as a polling server
     *
     * \details act as a polling server
     *
     * \mandatory: false
     *
    ...
    public String getpolling_server() {
        @SuppressWarnings("unused")
        final String conMethodName = conClassName + "::getpolling_server";
        return PollingServer.Value();
    } // public String getpolling_server

    public SOSFtpOptionsSuperClass setpolling_server(final String pstrValue) {
        @SuppressWarnings("unused")
        final String conMethodName = conClassName + "::setpolling_server";
        PollingServer.Value(pstrValue);
        return this;
    } // public SOSFtpOptionsSuperClass setpolling_server

    /** \option polling_end_at \type SOSOptionTime \brief polling_end_at -
     * PollingServer should stop at the specified date/time
     *
     * \details PollingServer should stop at the specified date/time
     *
     * \mandatory: false
     *
    ...
    public String getpolling_end_at() {
        @SuppressWarnings("unused")
        final String conMethodName = conClassName + "::getpolling_end_at";
        return pollingEndAt.Value();
    } // public String getpolling_end_at

    public SOSFtpOptionsSuperClass setpolling_end_at(final String pstrValue) {
        @SuppressWarnings("unused")
        final String conMethodName = conClassName + "::setpolling_end_at";
        pollingEndAt.Value(pstrValue);
        return this;
    } // public SOSFtpOptionsSuperClass setpolling_end_at

    /** \option polling_server_poll_forever \type SOSOptionBoolean \brief
     * polling_server_poll_forever - Poll until forever - 1 day
     *
     * \details poll forever
     *
     * \mandatory: true
     *
    ...
    public String getpolling_server_poll_forever() {
        @SuppressWarnings("unused")
        final String conMethodName = conClassName + "::getpolling_server_poll_forever";
    ...
    public SOSFtpOptionsSuperClass setpolling_server_poll_forever(final String pstrValue) {
        @SuppressWarnings("unused")
        final String conMethodName = conClassName + "::setpolling_server_poll_forever";
        PollingServerPollForever.Value(pstrValue);
        return this;
    } // public SOSFtpOptionsSuperClass setpolling_server_poll_forever

    /** \option polling_duration \type SOSOptionTime \brief polling_duration -
     * How long the PollingServer should run
     *
     * \details How long the PollingServer should run
     *
     * \mandatory: false
     *
    ...
    public String getpolling_server_duration() {
        @SuppressWarnings("unused")
        final String conMethodName = conClassName + "::getpolling_duration";
    ...
    public SOSFtpOptionsSuperClass setpolling_server_duration(final String pstrValue) {
        @SuppressWarnings("unused")
        final String conMethodName = conClassName + "::setpolling_duration";
        pollingServerDuration.Value(pstrValue);
        return this;
    } // public SOSFtpOptionsSuperClass setpolling_duration

    /** \option Lazy_Connection_Mode \type SOSOptionBoolean \brief
     * Lazy_Connection_Mode - Connect to Target as late as possible
     *
     * \details Connect to Target as late as possible
     *
    ...
    public String getLazy_Connection_Mode() {
        @SuppressWarnings("unused")
        final String conMethodName = conClassName + "::getLazy_Connection_Mode";
        return LazyConnectionMode.Value();
    } // public String getLazy_Connection_Mode

    public SOSFtpOptionsSuperClass setLazy_Connection_Mode(final String pstrValue) {
        @SuppressWarnings("unused")
        final String conMethodName = conClassName + "::setLazy_Connection_Mode";
        LazyConnectionMode.Value(pstrValue);
        return this;
    } // public SOSFtpOptionsSuperClass setLazy_Connection_Mode

    /** \option platform \type SOSOptionString \brief platform - platform on
     * which the app is running
     *
     * \details platform on which the app is running
     *
     * \mandatory: false
     *
    ...
    /** \option mail_on_success \type SOSOptionBoolean \brief mail_on_success -
     * Send a Mail in case of sucess
     *
     * \details Send a Mail in case of sucess
     *
     * \mandatory: false
     *
    ...
    public String getmail_on_success() {
        @SuppressWarnings("unused")
        final String conMethodName = conClassName + "::getmail_on_success";
        return mail_on_success.Value();
    } // public String getmail_on_success

    public SOSFtpOptionsSuperClass setmail_on_success(final String pstrValue) {
        @SuppressWarnings("unused")
        final String conMethodName = conClassName + "::setmail_on_success";
        mail_on_success.Value(pstrValue);
        return this;
    } // public SOSFtpOptionsSuperClass setmail_on_success

    /** \option mail_on_error \type SOSOptionBoolean \brief mail_on_error - Send
     * a Mail in case of sucess
     *
     * \details Send a Mail in case of sucess
     *
     * \mandatory: false
    ...
    public String getmail_on_error() {
        @SuppressWarnings("unused")
        final String conMethodName = conClassName + "::getmail_on_error";
        return mail_on_error.Value();
    } // public String getmail_on_error

    public SOSFtpOptionsSuperClass setmail_on_error(final String pstrValue) {
        @SuppressWarnings("unused")
        final String conMethodName = conClassName + "::setmail_on_error";
        mail_on_error.Value(pstrValue);
        return this;
    } // public SOSFtpOptionsSuperClass setmail_on_error

    /** \option mail_on_empty_files \type SOSOptionBoolean \brief
     * mail_on_empty_files - Send a Mail in case of empty files
     *
     * \details Send a Mail in case of empty files
     *
     * \mandatory: false
     *
     * \created 07.01.2013 17:27:51 by KB */
    ...
    public String getmail_on_empty_files() {
        @SuppressWarnings("unused")
        final String conMethodName = conClassName + "::getmail_on_empty_files";
        return mail_on_empty_files.Value();
    } // public String getmail_on_empty_files

    public SOSFtpOptionsSuperClass setmail_on_empty_files(final String pstrValue) {
        @SuppressWarnings("unused")
        final String conMethodName = conClassName + "::setmail_on_empty_files";
        mail_on_empty_files.Value(pstrValue);
        return this;
    } // public SOSFtpOptionsSuperClass setmail_on_empty_files

    /** \option title \type SOSOptionString \brief title - The Title for a
     * section /profile
     *
     * \details The Title for a section /profile
     *
     * \mandatory: false
     *
    ...
    public String gettitle() {
        @SuppressWarnings("unused")
        final String conMethodName = conClassName + "::gettitle";
        return title.Value();
    } // public String gettitle

    public SOSFtpOptionsSuperClass settitle(final String pstrValue) {
        @SuppressWarnings("unused")
        final String conMethodName = conClassName + "::settitle";
        title.Value(pstrValue);
        return this;
    } // public SOSFtpOptionsSuperClass settitle

    /** \option keep_modification_date \type SOSOptionBoolean \brief
     * keep_modification_date - Keep Modification Date of File
     *
     * \details Keep Modification Date of File
     *
     * \mandatory: false
     *
    ...
    public String getcumulate_files() {
        @SuppressWarnings("unused")
        final String conMethodName = conClassName + "::getcumulate_files";
        return CumulateFiles.Value();
    } // public String getcumulate_files

    public SOSFtpOptionsSuperClass setcumulate_files(final String pstrValue) {
        @SuppressWarnings("unused")
        final String conMethodName = conClassName + "::setcumulate_files";
        CumulateFiles.Value(pstrValue);
        return this;
    } // public SOSFtpOptionsSuperClass setcumulate_files

    /** \option cumulative_filename \type SOSOptionFileName \brief
     * cumulative_filename - Name of File into which all files hat to be
     * cumulated
     *
     * \details Name of File into which all files hat to be cumulated
     *
     * \mandatory: false
     *
    ...
    public String getcumulative_filename() {
        @SuppressWarnings("unused")
        final String conMethodName = conClassName + "::getcumulative_filename";
        return CumulativeFileName.Value();
    } // public String getcumulative_filename

    public SOSFtpOptionsSuperClass setcumulative_filename(final String pstrValue) {
        @SuppressWarnings("unused")
        final String conMethodName = conClassName + "::setcumulative_filename";
        CumulativeFileName.Value(pstrValue);
        return this;
    } // public SOSFtpOptionsSuperClass setcumulative_filename

    /** \option cumulative_file_separator \type SOSOptionString \brief
     * cumulative_file_separator - Text which has to beplaced between cumulated
     * files
     *
     * \details Text which has to beplaced between cumulated files. A text
     * string or a file name, which contains the text of the file separator, is
     * a possible value.
     *
     * \mandatory: false
     *
    ...
    public String getcumulative_file_separator() {
        @SuppressWarnings("unused")
        final String conMethodName = conClassName + "::getcumulative_file_separator";
        return CumulativeFileSeparator.Value();
    } // public String getcumulative_file_separator

    public SOSFtpOptionsSuperClass setcumulative_file_separator(final String pstrValue) {
        @SuppressWarnings("unused")
        final String conMethodName = conClassName + "::setcumulative_file_separator";
        CumulativeFileSeparator.Value(pstrValue);
        return this;
    } // public SOSFtpOptionsSuperClass setcumulative_file_separator

    /** \option cumulative_file_delete \type SOSOptionBoolean \brief
     * cumulative_file_delete - Delete cumulative file before starting transfer
     *
     * \details Delete cumulative file before starting transfer
     *
     * \mandatory: false
     *
    ...
    public String getcumulative_file_delete() {
        @SuppressWarnings("unused")
        final String conMethodName = conClassName + "::getcumulative_file_delete";
        return CumulativeFileDelete.Value();
    } // public String getcumulative_file_delete

    public SOSFtpOptionsSuperClass setcumulative_file_delete(final String pstrValue) {
        @SuppressWarnings("unused")
        final String conMethodName = conClassName + "::setcumulative_file_delete";
        CumulativeFileDelete.Value(pstrValue);
        return this;
    } // public SOSFtpOptionsSuperClass setcumulative_file_delete

    /** \option Post_Command \type SOSOptionString \brief Post_Command -
     * FTP-Command to be executed after transfer
     *
     * \details FTP-Command to be executed after transfer for each file.
     *
     * \mandatory: false
     *
    ...
    /** \option Pre_Command \type SOSOptionString \brief Pre_Command - A
     * FTP-Command to be execute before transfer of each file is starting
     *
     * \details
     *
     *
    ...
    /** \option CheckServerFeatures \type SOSOptionBoolean \brief
     * CheckServerFeatures - get the provided features of a ftp-server
     *
     * \details The available features of a ftp-server
     *
     * \mandatory: false
     *
    ...
    /** \option PollKeepConnection \type SOSOptionBoolean \brief
     * PollKeepConnection - Keep connection during polling
     *
     * \details With this parameter it is possible to close the connection to
     * the server after an unsucsesfull polling cycle. The connection will be
     * established before the next cycle will start.
     *
     * \mandatory: false
     *
    ...
    /** \option FileNameEncoding \type SOSOptionString \brief FileNameEncoding -
     * Set the encoding-type of a file name
     *
     * \details Set the encoding-type of a file name
     *
     * \mandatory: false
     *
    ...
    /** \option Strict_HostKey_Checking \type SOSOptionValueList \brief
     * Strict_HostKey_Checking - Check the hostKey against known hosts for SSH
     *
     * \details Check the hostkey against known hosts for SSH
     *
     * \mandatory: false
     *
    ...
    /** \option ControlEncoding \type SOSOptionString \brief ControlEncoding -
     * Specify the encoding-type used by the server
     *
     * \details Specify the encoding-type, e.g. utf-8 or iso-8859-1, used by the
     * server
     *
     * \mandatory: false
     *
    ...
    /** \option History_File_Append_Mode \type SOSOptionBoolean \brief
     * History_File_Append_Mode - Specifies wether the History File has to be
     * written in append mode
     *
     * \details Specifies wether the History File has to be written in append
     * mode
     *
     * \mandatory: false
     *
    ...
    public SOSOptionBoolean getHistoryFileAppendMode() {
        @SuppressWarnings("unused")
        final String conMethodName = conClassName + "::getHistory_File_Append_Mode";
    ...
    public SOSFtpOptionsSuperClass setHistoryFileAppendMode(final SOSOptionBoolean pstrValue) {
        @SuppressWarnings("unused")
        final String conMethodName = conClassName + "::setHistory_File_Append_Mode";
        HistoryFileAppendMode = pstrValue;
        return this;
    } // public SOSFtpOptionsSuperClass setHistory_File_Append_Mode

    /** \option HistoryEntries \type SOSOptionArrayList \brief HistoryEntries -
     * List of additional entries for the transfer history
     *
     * \details List of additional entries for the transfer history.
     *
     * \mandatory: false
     *
    ...
    /** \option SendTransferHistory \type SOSOptionBoolean \brief
     * SendTransferHistory - Send transfer history to background service
     *
     * \details If this option is set to true, the the transfer history will be
     * sent to the background service.
     *
     * \mandatory: false
     *
    ...
    /** \option Scheduler_Transfer_Method \type SOSOptionJSTransferMethod \brief
     * Scheduler_Transfer_Method - How to communicate with the JobScheduler
     *
     ...
     *
     *
     * \return Activate file-order creation With this parameter it is possible
     * to specif */
    public SOSOptionBoolean getcreate_order() {
        return create_order;
    }

    /** \brief setcreate_order : Activate file-order creation With this parameter
     * it is possible to specif
     *
     * \details
     *
     *
     * @param create_order : Activate file-order creation With this parameter it
     *            is possible to specif */
    public void setcreate_order(final SOSOptionBoolean p_create_order) {
        create_order = p_create_order;
    }

    /** \var create_orders_for_all_files : Create a file-order for every file in
     * the result-list */
    ...
    /** \brief setcreate_orders_for_all_files : Create a file-order for every
     * file in the result-list
     *
     * \details
     *
     *
     * @param create_orders_for_all_files : Create a file-order for every file
     *            in the result-list */
    ...
    /** \brief setexpected_size_of_result_set : number of expected hits in
     * result-list
     *
     * \details
     *
     *
     * @param expected_size_of_result_set : number of expected hits in
     *            result-list */
    ...
    /** \var file : File or Folder to watch for Checked file or directory
     * Supports */
    ...
    /** \brief setfile : File or Folder to watch for Checked file or directory
     * Supports
     *
     * \details
     *
     *
     * @param file : File or Folder to watch for Checked file or directory
     *            Supports */
    ...
    // /**
    // * \var gracious : Specify error message tolerance Enables or disables
    // error messages that
    // *
    // *
    // */
    // @JSOptionDefinition(name = "gracious", description =
    // "Specify error message tolerance Enables or disables error messages that",
    // key =
    // "gracious", type = "SOSOptionGracious", mandatory = false)
    // public SOSOptionGracious gracious = new SOSOptionGracious(this,
    // conClassName + ".gracious", // HashMap-Key
    // "Specify error message tolerance Enables or disables error messages that",
    // // Titel
    // "false", // InitValue
    // "false", // DefaultValue
    ...
    //
    // /**
    // * \brief getgracious : Specify error message tolerance Enables or
    // disables error messages that
    // *
    // * \details
    // *
    // *
    // * \return Specify error message tolerance Enables or disables error
    // messages that
    // *
    // */
    ...
    //
    // /**
    // * \brief setgracious : Specify error message tolerance Enables or
    // disables error messages that
    // *
    // * \details
    // *
    // *
    // * @param gracious : Specify error message tolerance Enables or disables
    // error messages that
    // */
    ...
    // }
    //
    // public SOSOptionGracious ErrorBehaviour = (SOSOptionGracious)
    // gracious.SetAlias(conClassName + ".ErrorBehaviour");
    /** \var max_file_age : maximum age of a file Specifies the maximum age of a
     * file. If a file */
     ...
     *
     *
     * \return maximum age of a file Specifies the maximum age of a file. If a
     * file */
    public SOSOptionTime getmax_file_age() {
        return max_file_age;
    }

    /** \brief setmax_file_age : maximum age of a file Specifies the maximum age
     * of a file. If a file
     *
     * \details
     *
     *
     * @param max_file_age : maximum age of a file Specifies the maximum age of
     *            a file. If a file */
    ...
    /** \var max_file_size : maximum size of a file Specifies the maximum size of
     * a file in Specifies the maximum size of a file in bytes: should the size
    ...
    /** \brief setmax_file_size : maximum size of a file Specifies the maximum
     * size of a file in
     *
     * \details Specifies the maximum size of a file in bytes: should the size
     * of one of the files exceed this value, then it is classified as
     * non-existing.
     *
     * @param max_file_size : maximum size of a file Specifies the maximum size
     *            of a file in */
    ...
    /** \var min_file_age : minimum age of a file Specifies the minimum age of a
     * files. If the fi Specifies the minimum age of a files. If the file(s) is
     * newer then it is classified as non-existing, it will be not included in
     * the result-list. */
     ...
     * result-list.
     *
     * \return minimum age of a file Specifies the minimum age of a files. If
     * the fi */
    public SOSOptionTime getmin_file_age() {
        return min_file_age;
    }

    /** \brief setmin_file_age : minimum age of a file Specifies the minimum age
     * of a files. If the fi
     *
     * \details Specifies the minimum age of a files. If the file(s) is newer
     * then it is classified as non-existing, it will be not included in the
     * result-list.
     *
     * @param min_file_age : minimum age of a file Specifies the minimum age of
     *            a files. If the fi */
    ...
    /** \var min_file_size : minimum size of one or multiple files Specifies the
     * minimum size of one */
     ...
     *
     *
     * \return minimum size of one or multiple files Specifies the minimum size
     * of one */
    public SOSOptionFileSize getmin_file_size() {
        return min_file_size;
    }

    /** \brief setmin_file_size : minimum size of one or multiple files Specifies
     * the minimum size of one
     *
     * \details
     *
     *
     * @param min_file_size : minimum size of one or multiple files Specifies
     *            the minimum size of one */
    ...
    /** \option MergeOrderParameter \type SOSOptionBoolean \brief
     * MergeOrderParameter - Merge created order parameter with parameter of
     * current order
     *
     * \details Merge created order parameter with parameter of current order
     *
     * \mandatory: false
     *
     ...
     *
     *
     * \return The first node to execute in a jobchain The name of the node of a
     * jobchai */
    public SOSOptionJobChainNode getnext_state() {
        return next_state;
    }

    /** \brief setnext_state : The first node to execute in a jobchain The name
     * of the node of a jobchai
     *
     * \details
     *
     *
     * @param next_state : The first node to execute in a jobchain The name of
     *            the node of a jobchai */
    public void setnext_state(final SOSOptionJobChainNode p_next_state) {
        next_state = p_next_state;
    }

    /** \var on_empty_result_set : Set next node on empty result set The next
     ...
     *
     *
     * \return Set next node on empty result set The next Node (Step, Job) to
     * execute i */
    public SOSOptionJobChainNode geton_empty_result_set() {
        return on_empty_result_set;
    }

    /** \brief seton_empty_result_set : Set next node on empty result set The
     * next Node (Step, Job) to execute i
     *
     * \details
     *
     *
     * @param on_empty_result_set : Set next node on empty result set The next
     *            Node (Step, Job) to execute i */
    ...
    /** \var order_jobchain_name : The name of the jobchain which belongs to the
     ...
     *
     *
     * \return The name of the jobchain which belongs to the order The name of
     * the jobch */
    public SOSOptionString getorder_jobchain_name() {
        return order_jobchain_name;
    }

    /** \brief setorder_jobchain_name : The name of the jobchain which belongs to
     * the order The name of the jobch
     *
     * \details
     *
     *
     * @param order_jobchain_name : The name of the jobchain which belongs to
     *            the order The name of the jobch */
    public void setorder_jobchain_name(final SOSOptionString p_order_jobchain_name) {
        order_jobchain_name = p_order_jobchain_name;
    }

    /** \var raise_error_if_result_set_is : raise error on expected size of
     ...
     *
     *
     * \return raise error on expected size of result-set With this parameter it
     * is poss */
    public SOSOptionRelOp getraise_error_if_result_set_is() {
        return raise_error_if_result_set_is;
    }

    /** \brief setraise_error_if_result_set_is : raise error on expected size of
     * result-set With this parameter it is poss
     *
     * \details
     *
     *
     * @param raise_error_if_result_set_is : raise error on expected size of
     *            result-set With this parameter it is poss */
    ...
    /** \var result_list_file : Name of the result-list file If the value of this
     ...
     *
     *
     * \return Name of the result-list file If the value of this parameter
     * specifies a v */
    public SOSOptionFileName getresult_list_file() {
        return result_list_file;
    }

    /** \brief setresult_list_file : Name of the result-list file If the value of
     * this parameter specifies a v
     *
     * \details
     *
     *
     * @param result_list_file : Name of the result-list file If the value of
     *            this parameter specifies a v */
    ...
    /** \brief setscheduler_file_name : Name of the file to process for a
     * file-order
     *
     * \details
     *
    ...
    /** \var scheduler_file_parent : pathanme of the file to process for a
     * file-order */
    ...
    /** \brief setscheduler_file_parent : pathanme of the file to process for a
     * file-order
     *
     * \details
     *
     *
     * @param scheduler_file_parent : pathanme of the file to process for a
     *            file-order */
    ...
    /** \var scheduler_file_path : file to process for a file-order Using
    ...
    /** \brief setscheduler_file_path : file to process for a file-order Using
     * Directory Monitoring with
     *
     * \details
     *
     *
     * @param scheduler_file_path : file to process for a file-order Using
     *            Directory Monitoring with */
    ...
    // /**
    // * \var scheduler_sosfileoperations_resultset : The result of the
    // operation as a list of items
    // *
    // *
    // */
    // @JSOptionDefinition(name = "scheduler_sosfileoperations_resultset",
    // description = "The result of the operation as a list of items",
    // key = "scheduler_sosfileoperations_resultset", type = "SOSOptionstring",
    // mandatory = false)
    // public SOSOptionString scheduler_sosfileoperations_resultset = new
    // SOSOptionString(this, conClassName +
    ...
    //
    // /**
    // * \brief getscheduler_sosfileoperations_resultset : The result of the
    // operation as a list of items
    // *
    // * \details
    // *
    ...
    //
    // /**
    // * \brief setscheduler_sosfileoperations_resultset : The result of the
    // operation as a list of items
    // *
    // * \details
    // *
    // *
    // * @param scheduler_sosfileoperations_resultset : The result of the
    // operation as a list of items
    // */
    // public void setscheduler_sosfileoperations_resultset(SOSOptionString
    // p_scheduler_sosfileoperations_resultset) {
    // this.scheduler_sosfileoperations_resultset =
    // p_scheduler_sosfileoperations_resultset;
    // }
    //
    // public SOSOptionString ResultSet = (SOSOptionString)
    // scheduler_sosfileoperations_resultset.SetAlias(conClassName
    // + ".ResultSet");
    //
    /** \var scheduler_sosfileoperations_resultsetsize : The amount of hits in
    ...
    public SOSOptionInteger scheduler_sosfileoperations_resultsetsize = new SOSOptionInteger(this, conClassName + ".scheduler_sosfileoperations_resultsetsize", // HashMap-Key
    ...
    /** \brief setscheduler_sosfileoperations_resultsetsize : The amount of hits
     * in the result set of the operation
     *
     * \details
     *
     *
     * @param scheduler_sosfileoperations_resultsetsize : The amount of hits in
     *            the result set of the operation */
    ...
    /** \var skip_first_files : number of files to remove from the top of the
     ...
     *
     *
     * \return number of files to remove from the top of the result-set The
     * numbe */
    public SOSOptionInteger getskip_first_files() {
        return skip_first_files;
    }

    /** \brief setskip_first_files : number of files to remove from the top of
     * the result-set The numbe
     *
     * \details
     *
     *
     * @param skip_first_files : number of files to remove from the top of the
     *            result-set The numbe */
    ...
    /** \var skip_last_files : number of files to remove from the bottom of the
     * result-set The numbe */
     ...
     *
     *
     * \return number of files to remove from the bottom of the result-set The
     * numbe */
    public SOSOptionInteger getskip_last_files() {
        return skip_last_files;
    }

    /** \brief setskip_last_files : number of files to remove from the bottom of
     * the result-set The numbe
     *
     * \details
     *
     *
     * @param skip_last_files : number of files to remove from the bottom of the
     *            result-set The numbe */
    ...
    /** \option Max_Files \type SOSOptionInteger \brief Max_Files - Maximum
     * number of files to process
     *
     * \details Maximum number of files to process
     *
     * \mandatory: false
     *
    ...
    public String getMax_Files() {
        @SuppressWarnings("unused")
        final String conMethodName = conClassName + "::getMax_Files";
        return MaxFiles.Value();
    } // public String getMax_Files

    public SOSFtpOptionsSuperClass setMax_Files(final String pstrValue) {
        @SuppressWarnings("unused")
        final String conMethodName = conClassName + "::setMax_Files";
        MaxFiles.Value(pstrValue);
        return this;
    } // public SOSFtpOptionsSuperClass setMax_Files

    /** \option check_steady_count \type SOSOptionInteger \brief
     * check_steady_count - Number of tries for Steady check
     *
     * \details Number of tries for Steady check
     *
     * \mandatory: false
     *
    ...
    public String getcheck_steady_count() {
        @SuppressWarnings("unused")
        final String conMethodName = conClassName + "::getcheck_steady_count";
        return CheckSteadyCount.Value();
    } // public String getcheck_steady_count

    public SOSFtpOptionsSuperClass setcheck_steady_count(final String pstrValue) {
        @SuppressWarnings("unused")
        final String conMethodName = conClassName + "::setcheck_steady_count";
        CheckSteadyCount.Value(pstrValue);
        return this;
    } // public SOSFtpOptionsSuperClass setcheck_steady_count

    /** \option check_steady_state_interval \type SOSOptionFileTime \brief
     * check_steady_state_interval - The intervall for steady state checking
     *
     * \details The intervall for steady state checking
     *
     * \mandatory: false
     *
    ...
    public String getcheck_steady_state_interval() {
        @SuppressWarnings("unused")
        final String conMethodName = conClassName + "::getcheck_steady_state_interval";
    ...
    public SOSFtpOptionsSuperClass setcheck_steady_state_interval(final String pstrValue) {
        @SuppressWarnings("unused")
        final String conMethodName = conClassName + "::setcheck_steady_state_interval";
        check_steady_state_interval.Value(pstrValue);
        return this;
    } // public SOSFtpOptionsSuperClass setcheck_steady_state_interval

    /** \option CheckSteadyStateOfFiles \type SOSOptionBoolean \brief
     * CheckSteadyStateOfFiles - Check wether a file is beeing modified
     *
     * \details Check wether a file is beeing modified
     *
     * \mandatory: false
     *
    ...
    public String getPollErrorState() {
        @SuppressWarnings("unused")
        final String conMethodName = conClassName + "::getPollErrorState";
        return PollErrorState.Value();
    } // public String getPollErrorState

    public SOSFtpOptionsSuperClass setPollErrorState(final String pstrValue) {
        @SuppressWarnings("unused")
        final String conMethodName = conClassName + "::setPollErrorState";
        PollErrorState.Value(pstrValue);
        return this;
    } // public SOSFtpOptionsSuperClass setPollErrorState

    /** \option Steady_state_error_state \type SOSOptionString \brief
     * Steady_state_error_state - Next state in JobChain if check steady state
     * did not comes to an normal end
     *
     * \details Next state in JobChain if check steady state did not comes to an
     * normal end
     *
     * \mandatory: false
     *
    ...
    public String getSteady_state_error_state() {
        @SuppressWarnings("unused")
        final String conMethodName = conClassName + "::getSteady_state_error_state";
        return Steady_state_error_state.Value();
    } // public String getSteady_state_error_state

    public SOSFtpOptionsSuperClass setSteady_state_error_state(final String pstrValue) {
        @SuppressWarnings("unused")
        final String conMethodName = conClassName + "::setSteady_state_error_state";
        Steady_state_error_state.Value(pstrValue);
        return this;
    } // public SOSFtpOptionsSuperClass setSteady_state_error_state

    /** \option make_Dirs \type SOSOptionBoolean \brief make_Dirs - Create
     * missing Directory on Target
     *
     * \details Create missing Directory on Target
     *
     * \mandatory: false
     *
    ...
    /** \option FileListName \type SOSOptionInFileName \brief FileListName - File
     * with a list of file names
     *
     * \details File with a list of file names
     *
     * \mandatory: false
     *
    ...
    public String getFileListName() {
        @SuppressWarnings("unused")
        final String conMethodName = conClassName + "::getFileListName";
        return FileListName.Value();
    } // public String getFileListName

    public SOSFtpOptionsSuperClass setFileListName(final String pstrValue) {
        @SuppressWarnings("unused")
        final String conMethodName = conClassName + "::setFileListName";
        FileListName.Value(pstrValue);
        return this;
    } // public SOSFtpOptionsSuperClass setFileListName

    /** \option CreateResultSet \type SOSOptionBoolean \brief CreateResultSet -
     * Write the ResultSet on a File if True
     *
     * \details Write the ResultSet to a file
     *
     * \mandatory: false
     *
    ...
    public String getCreateResultSet() {
        @SuppressWarnings("unused")
        final String conMethodName = conClassName + "::getCreateResultSet";
        return CreateResultSet.Value();
    } // public String getCreateResultSet

    public SOSFtpOptionsSuperClass setCreateResultSet(final String pstrValue) {
        @SuppressWarnings("unused")
        final String conMethodName = conClassName + "::setCreateResultSet";
        CreateResultSet.Value(pstrValue);
        return this;
    } // public SOSFtpOptionsSuperClass setCreateResultSet

    /** \option ResultSetFileName \type SOSOptionFileName \brief
     * ResultSetFileName - Name of a File with a filelist or a resultlist
     *
     * \details The value of this parameter ...
     *
     * \mandatory: false
     *
    ...
    public String getResultSetFileName() {
        @SuppressWarnings("unused")
        final String conMethodName = conClassName + "::getResultSetFileName";
        return ResultSetFileName.Value();
    } // public String getResultSetFileName

    public SOSFtpOptionsSuperClass setResultSetFileName(final String pstrValue) {
        @SuppressWarnings("unused")
        final String conMethodName = conClassName + "::setResultSetFileName";
    ...
    /** \var alternative_account : Alternative parameter for the primary
     * parameter
     *
     * Alternative parameter for the primary parameter account. The alternative
     * parameters are used solely should the connection to an FTP/SFTP server
     * fail, e.g. if the server were not available or if invalid credentials
     * were used. */
     ...
     *
     * Alternative parameter for the primary parameter host. The alternative
     * parameters are used solely should the connection to an FTP/SFTP server
     * fail, e.g. if the server were not available or if invalid credentials
     * were used. */
    ...
    /** \var alternative_passive_mode : Alternative parameter for the primary
     * parameter
     *
     * Alternative parameter for the primary parameter passive_mode. The
    ...
    /** \var alternative_password : Alternative parameter for the primary
     * parameter
     *
     * Alternative parameter for the primary parameter password. The alternative
     * parameters are used solely should the connection to an FTP/SFTP server
     * fail, e.g. if the server were not available or if invalid credentials
     * were used. */
     ...
     *
     * Alternative parameter for the primary parameter port. The alternative
     * parameters are used solely should the connection to an FTP/SFTP server
     * fail, e.g. if the server were not available or if invalid credentials
     * were used. */
    ...
    /** \var alternative_remote_dir : Alternative parameter for the primary
     * parameter
     *
     * Alternative parameter for the primary parameter remote_dir. The
     * alternative parameters are used solely should the connection to an
     * FTP/SFTP server fail, e.g. if the server were not available or if invalid
     * credentials were used. */
    ...
    /** \var alternative_transfer_mode : Alternative parameter for the primary
     * parameter
     *
     * Alternative parameter for the primary parameter transfer_mode. The
     * alternative parameters are used solely should the connection to an
     * FTP/SFTP server fail, e.g. if the server were not available or if invalid
     * credentials were used. */
     ...
     *
     * Alternative parameter for the primary parameter user. The alternative
     * parameters are used solely should the connection to an FTP/SFTP server
     * fail, e.g. if the server were not available or if invalid credentials
     * were used. */
     ...
     *
     * This parameter specifies whether the content of a source file should be
     * appended to the target file should this file exist. The parameter
     * overwrite_files will be ignored if this parameter is specified with the
     * value true. */
     ...
     *
     * This parameter specifies whether target files should be created with a
     * prefix such as "~", and must be renamed to the target file name after the
     * file transfer is completed without errors. This mechanism is useful if
     * the target directory is monitored for incoming files by some application
     * and if files are required to appear atomically instead of being
     * subsequently written to. The temporary prefix is specified as the value
     * of this parameter. This setting is recommended should target directories
     ...
     * directory is monitored for incoming files by some application and if
     * files are required to appear atomically instead of being subsequently
     ...
     * file list and footer. This parameter specifies a template file for footer
     * output. Templates can use internal variables and parameters as
     ...
     * by the parameter log_filename. A template can be used in order to
     * organize the output that is created. The output is grouped into header,
     * file list and footer. This parameter specifies a template file for header
     * output. Templates can use internal variables and parameters as
     ...
     *
     * This parameter specifies the interval in seconds between two file
     * transfer trials, if repeated transfer of files has been configured using
     ...
     *
     * This parameter specifies whether a file transfer should be repeated in
     ...
     * file at the same time. This parameter causes the size of the current file
     * transfer and of the previous file transfer to be compared and repeats
     * transferring one file up to the number of trials specified by this
     * parameter. Should the file size of both transfers be the same, then it is
     * assumed that the file was complete at the FTP/SFTP server. The interval
     * between two trials to transfer a file is configured using the
     ...
     *
     * This parameter determines whether the original file size and the number
     * of bytes transferred should be compared after a file transfer and whether
     ...
     *
     * The parameter is used during installation of this program on a remote
     * server with the parameter operation=installcode>. This parameter
    ...
    /** \var compress_files : This parameter specifies whether the content of the
     * source files
     *
     * This parameter specifies whether the content of the source files should
     * be compressed by using a zip-algorithm or not. In case of sending files
     ...
     *
     * This parameter is used for Unix systems and - as opposed to other
     * parameters - is usually specified in the start script sosftp.sh. The
     * value of the environment variable $$ is assigned, that contains the
     ...
     *
     * This parameter is used alternatively to the parameter file_spec to
     * specify a single file for transfer. When receiving files the following
     ...
     *
     * This parameter expects a regular expression to select files from a local
     * directory or from an FTP/SFTP server (depending on the operation
    ...
    // *
    // In addition to what is stated for the parameter file_spec additional
    ...
    // -param_set_2="transfer_mode=binary::remote_dir=/tmp/2::local_dir=/tmp/2"
    // Within the file_spec2 parameter value the regular expression
    // is separated by :: from the name of a file set. This name can freely be
    // chosen, it consists of the characters 0-9, a-z and _. The
    // name of the file set is used as a separate parameter in the command line.
    // This parameter is assigend the list of parameters that
    // should be valid for the specific file set. Therefore the names and values
    // of individual parameters are specified in the form
    // name=value::name2=value2 .... Such parameters are exclusively valid for
    // the specific file set. The above sample causes all files with
    // the extension .gif to be transferred from the local directory /tmp/1 to a
    // directory with the same name on the target host. For files
    // with the extension .exe a file set param_set_2 is specified that contains
    // parameters that are specific for this file set, as binary
    // transfer and different source and target directories. Please, consider
    // that parameter file sets cannot specify parameters that
    // control the connection to a target host, i.e. all files are transferred
    // between the same local and remote hosts. However, the
    // transfer direction can be changed, e.g. by specifying a different
    // operation parameter for a file set.
    // *
    // */
    // @JSOptionDefinition(name = "file_spec2", description =
    // "In addition to what is stated for the parameter fi", key = "file_spec2",
    // type
    // = "SOSOptionRegExp", mandatory = false)
    // public SOSOptionRegExp file_spec2 = new SOSOptionRegExp(this,
    // conClassName + ".file_spec2", // HashMap-Key
     ...
     *
     * This parameter specifies whether an error should be raised if no files
     * could be found for transfer. The number of files to be transferred is
     * determined by the file_spec or file_path parameters and can be restricted
     * by the overwrite_files parameter should this be specified with the value
     * false. */
     ...
     *
     * This parameter causes a history file to be written in CSV format. The
     * path and name of the history file is specified as value for this
     * parameter. A history record is created for each file that has been
     ...
     *
     * The parameter is used in order to synchronize parallel write access to
     * the history file by multiple instances of this program. This parameter
     * specifies the maximum number of repeat intervals when trying to write to
     * the history file if the history file is locked due to parallel instances
     * of this program. */
    ...
    /** \var history_repeat_interval : The parameter is used in order to
     * synchronize para
     *
     * The parameter is used in order to synchronize parallel write access to
     * the history file by multiple instances of this program. This parameter
     * specifies the the interval in seconds of repeated trials to write to the
     * history file if the history file is locked due to parallel instances of
     * this program. */
     ...
     *
     * This parameter specifies the hostname or IP address of the server to
     ...
     * used in order to establish a connection to the SSH server via SSL/TLS.
     * The use of a proxy is optional and exclusively considered if the
     ...
     *
     * This parameter specifies the port of a proxy that is used in order to
     * establish a connection to the SSH server via SSL/TLS, see parameter
     * http_proxy_host. */
     ...
     *
     * This parameter specifies a command that is to be executed on the SSH
     * server. Multiple commands can be separated by the command delimiter that
    ...
    /** \var jump_command_delimiter : Command delimiter characters are specified
     * using t
     *
     * Command delimiter characters are specified using this parameter. These
     * delimiters can then be used in the jump_command parameter to seperate
     * multiple commands. These commands are then excecuted in separate SSH
     * sessions. */
    ...
    /** \var jump_command_script : This parameter can be used as an alternative
     * to ju
     *
     * This parameter can be used as an alternative to jump_command,
    ...
    /** \var jump_command_script_file : This parameter can be used as an
     * alternative to ju
     *
     * This parameter can be used as an alternative to jump_command,
     ...
     *
     * When using a jump_host then files are first transferred to this host and
     * then to the target system. Different protocols (FTP/SFTP) can be used for
     * these transfer operations. Host or IP address of the jump_host from which
    ...
    /** \var jump_ignore_error : Should the value true be specified, then
     * execution
     *
     * Should the value true be specified, then execution errors caused by
     * commands on the SSH server are ignored. Otherwise such execution errors
     * will be reported. */
     ...
     *
     * Should the value true be specified, then on Unix systems all signals will
     * be ignored that terminate the execution of a command on the SSH server -
     * if for example a command is terminated using kill. Note that by default
    ...
    /** \var jump_ignore_stderr : This job checks if any output to stderr has
     * been c
     *
     * This job checks if any output to stderr has been created by a command
     ...
     *
     * Port on the jump_host by which files should be transferred. For FTP this
     ...
     * When using a jump_host then files are first transferred to this host and
     * then to the target system. Different protocols (FTP/SFTP) can be used for
     * these transfer operations. This parameter expects ftp, sftp or ftps to be
     * specified. If sftp is used, then the jump_ssh_* parameters will be
     * considered. */
     ...
     *
     * The value of this parameter is the host name or the IP address of a proxy
     * used in order to establish a connection to the jump host. The use of a
     * proxy is optional. */
    ...
    /** \var jump_proxy_password : This parameter specifies the password for the
     * prox
     *
     ...
     * by the proxy server should a proxy be used in order to connect to the
    ...
    /** \var jump_simulate_shell : Should the value true be specified for this
     * parame
     *
     * Should the value true be specified for this parameter, then a login to a
     * shell is simulated to execute commands. Some scripts may cause problems
    ...
    /** \var jump_simulate_shell_inactivity_timeout : If no new characters are
     * written to stdout or stde
     *
     * If no new characters are written to stdout or stderr after the given
    ...
    /** \var jump_simulate_shell_login_timeout : If no new characters are written
     * to stdout or stde
     *
     * If no new characters are written to stdout or stderr after the given
     * number of milliseconds, then it is assumed that the login has been
     * carried out and that the shell is waiting for the next command. */
    ...
    /** \var jump_simulate_shell_prompt_trigger : The expected command line
     * prompt. Using this promp
     *
     * The expected command line prompt. Using this prompt the program tries to
     * find out if commands may be entered or have been carried out. If no
     * prompt can be configured, then timeout parameters have to be used in
    ...
    /** \var jump_ssh_auth_file : This parameter specifies the path and name of a
     * us
     *
     * This parameter specifies the path and name of a user's private key file
     * used for login to the SSH server of the jump_host. This parameter must be
     * specified if the publickey authentication method has been specified in
     * the jump_ssh_auth_method parameter. Should the private key file be
     * secured by a password, then this password has to be specified using the
    ...
    /** \var jump_ssh_auth_method : This parameter specifies the authentication
     * method
     *
     * This parameter specifies the authentication method for the SSH server -
     * the publickey and password methods are supported. When the publickey
     * authentication method is used, then the path name of the private key file
     * must be set in the jump_ssh_auth_file parameter. Should the private key
     * file be secured by a passphrase then this passphrase has to be specified
     * by the jump_password parameter. For the password authentication method
     * the password for the user account has to be specified using the
     * jump_password parameter. The authentication methods that are enabled
     * depend on the SSH server configuration. Not all SSH servers are
     ...
     * default the current working directory is used. Besides paths in the local
     * file system UNC path names are supported that could be used to address
     * remote server systems: \\somehost\somedirectory can be used in the same
     * way as //somehost/somedirectory to transfer files from an FTP/SFTP server
     * to a different remote server system. Moreover, you could specify URIs for
     * a file schema as in file:////somehost/somedirectory. Please, consider the
     * required number of slashes. file URIs are subject to the following
     * limitations due to constraints of the underlying Java JRE: File names and
     * path names must not contain any spaces. Authentication by authority
     * strings as in file:////user:password@somehost/somedirectory is not
     * supported. */
     ...
     *
     * This parameter specifies the mandator for which a file transfer is
     * effected. The mandator is added to an optional history file, see
     ...
     *
     * send, receive, remove, execute or install. send - transfer files by
     * FTP/SFTP to a remote server receive - transfer files by FTP/SFTP from a
     * remote server remove - remove files by FTP/SFTP on a remote server
     ...
     *
     * This parameter specifies if existing files should be overwritten. Should
     * this parameter be used with force_files und should no files be
     * transferred due to overwrite protection then an error will be raised
     ...
     *
     * Passive mode for FTP is often used with firewalls. Valid values are 0 or
     * 1. */
     ...
     *
     * Password for authentication at the FTP/SFTP server. For SSH/SFTP
     ...
     *
     * This parameter specifies the interval in seconds, how often a file is
    ...
    /** \option Waiting_for_Late_comers \type SOSOptionBoolean \brief
     * Waiting_for_Late_comers - Wait an addtional interval for late comers
     *
     * \details Wait an additional interval for late comers
     *
     * \mandatory: false
     *
    ...
    public String getWaiting_for_Late_comers() {
        @SuppressWarnings("unused")
        final String conMethodName = conClassName + "::getWaiting_for_Late_comers";
        return WaitingForLateComers.Value();
    } // public String getWaiting_for_Late_comers

    public SOSFtpOptionsSuperClass setWaiting_for_Late_comers(final String pstrValue) {
        @SuppressWarnings("unused")
        final String conMethodName = conClassName + "::setWaiting_for_Late_comers";
     ...
     *
     * This parameter specifies the number of files that have to be found during
     * the polling period in order to cause the transfer to start. This
    ...
    /** \option PollingDuration \type SOSOptionTime \brief PollingDuration - The
     * duration of the polling period
     *
     * \details The duration of the polling period
     *
     * \mandatory: false
     *
    ...
    public String getPollingDuration() {
        @SuppressWarnings("unused")
        final String conMethodName = conClassName + "::getPollingDuration";
        return PollingDuration.Value();
    } // public String getPollingDuration

    public SOSFtpOptionsSuperClass setPollingDuration(final String pstrValue) {
        @SuppressWarnings("unused")
        final String conMethodName = conClassName + "::setPollingDuration";
     ...
     * for. If a file becomes available within the time specified then it will
     ...
     *
     * Port by which files should be transferred. For FTP this is usually port
     ...
     * This parameter is used for Unix systems and - as opposed to other
     * parameters - is usually specified in the start script sosftp.sh. The
     * value of the environment variable $PPID is assigned, that contains the
     * process id of the current parent process (PPID). The parent process id is
     * used when writing an entry to a history file for each transfer (see
     * parameter history). */
     ...
     *
     * If a configuration file is being used (see parameter settings), then this
     * parameter specifies a name of a section within the configuration file.
     * Such sections, i.e. profiles, specify parameters as pairs of names and
     * values that otherwise would be specified by command line parameters. At
     * the command line the name of the configuration file and the profile are
     * specified like this: sosftp.sh -operation=send -settings=settings.ini
     ...
     *
     * The values ftp, sftp or ftps are valid for this parameter. If sftp is
     ...
     *
     * This parameter specifies if files from subdirectories should be
     ...
     * transferred. By default the home directory of the user at the FTP/SFTP
     * server is used. */
     ...
     *
     * This parameter specifies whether files on the FTP/SFTP server should be
     ...
     *
     * String for replacement of matching character sequences within file names
     * that are specified with the value of the parameter replacing. If multiple
     * "capturing groups" shall be replaced then one replacement string per
     * group has to be specified. These strings are separated by a semicolon
     * ";": replacement: aa;[filename:];bb Supports masks for substitution in
     * the file name with format strings that are enclosed with [ and ] . The
     * following format strings are supported: [date: date format ] date format
     * must be a valid Java data format string, e.g. yyyyMMddHHmmss ,
     * yyyy-MM-dd.HHmmss etc. [filename:] Will be substituted by the original
     * file name including the file extension. [filename:lowercase] Will be
     * substituted by the original file name including the file extension with
     * all characters converted to lower case. [filename:uppercase] Will be
     * substituted by the original file name including the file extension with
     * all characters converted to upper case. Requires the parameter replacing
     * to be specified. */
     ...
     *
     * Regular expression for filename replacement with the value of the
     * parameter replacement. If the expression matches the filename then the
     * groups found are replaced. a) For replacement "capturing groups" are
     ...
     *
     * The parameter specifies the directory in which this program is allowed to
     * create temporary files. Temporary files are required if due to the
     * parameter setting jump_host files have to be stored on an intermediary
     * server and will be removed after completion of the transfer. Without this
     * parameter the temporary directory is used as provided by the operating
     * system. */
     ...
     *
     * This parameter specifies the host name or IP address of a server for
     * which Job Scheduler is operated for Managed File Transfer. The contents
     * of an optional history file (see parameter history), is added to a
     * central database by Job Scheduler. This parameter causes the transfer of
     * the history entries for the current transfer by UDP to Job Scheduler.
    ...
    /** \var scheduler_job_chain : The name of a job chain for Managed File
     * Transfer
     *
     * The name of a job chain for Managed File Transfer with Job Scheduler, see
     * parameter scheduler_host. The job chain accepts history entries and
    ...
    /** \var scheduler_port : The port for which a Job Scheduler for Managed File
     * Trans
     *
     * The port for which a Job Scheduler for Managed File Transfer is operated,
    ...
    /** \option Restart \type SOSOptionBoolean \brief Restart - Set
     * Restart/Resume Mode for Transfer
     *
     * \details Set Restart/Reesume Mode for Transfer
     *
     * \mandatory: false
     *
    ...
    public String getRestart() {
        @SuppressWarnings("unused")
        final String conMethodName = conClassName + "::getRestart";
        return Restart.Value();
    } // public String getRestart

    public SOSFtpOptionsSuperClass setRestart(final String pstrValue) {
        @SuppressWarnings("unused")
        final String conMethodName = conClassName + "::setRestart";
     ...
     *
     * A configuration (INI-) file can be specified that contains profiles, i.e.
     * sections, with parameters specified as pairs of names and values in a
     * plain text format like this: [sample_transfer] protocol = ftp host =
     * localhost port = 21 local_dir = /tmp ... At the command line the name of
     * the configuration file and the profile are specified like this: sosftp.sh
     * -operation=send -settings=settings.ini -profile=sample_transfer ... A
     * profile can reference the contents of other profiles like this: [default]
     * history = /sosftp/transfer_history.csv mandator = SOS scheduler_host =
     * localhost scheduler_port = 4444 [sample_transfer] include = default
     * protocol = ftp host = www.sos-berlin.com port = 21 local_dir = /tmp ...
     * With this sample the profile sample_transfer includes the default profile
     * via the include directive and thus applies the file transfer history
     * settings. */
     ...
     *
     * If this Parameter is set to true then all operations except for the
     * transfer itself will be performed. This can be used to just trigger for
     ...
     *
     * This parameter specifies the path and name of a user's private key file
     * that is used for authentication with an SSH server. This parameter has to
     * be specified should the publickey authentication method have been
     * specified in the ssh_auth_method parameter. Should the private key file
     * be secured by a passphrase, then the passphrase has to be specified using
     ...
     *
     * This parameter specifies the authentication method for the SSH server -
     * the publickey and password methods are supported. Should the publickey
     * authentication method be used, then the path name of the private key file
     * has to be specified with the ssh_auth_file parameter. Should the private
     * key file be secured by a passphrase then the passphrase has to be
     * specified with the password parameter. For the password authentication
     * method the password for the user account has to be specified using the
     * password parameter. The authentication methods that are enabled depend on
     * the SSH server configuration. Not all SSH servers are configured for
     ...
     *
     * The value of this parameter is the host name or the IP address of a proxy
     * that is used in order to establish a connection to the SSH server. The
    ...
    /** \var ssh_proxy_password : This parameter specifies the password for the
     * prox
     *
     * This parameter specifies the password for the proxy server user account,
     ...
     *
     * This parameter specifies the port number of the proxy, should a proxy be
     ...
     *
     * The value of this parameter specifies the user account for authentication
     * by the proxy server should a proxy be used in order to connect to the SSH
     * server. */
     ...
     *
     * This parameter specifies if file transfers should be operated within a
     * single transaction, i.e. either all files are successfully transferred or
     * none. Should an error occur during a transfer operation then all
     * transfers will be rolled back. When specifying the value true then the
     * following applies: The parameter atomic_suffix has to be specified that
     * causes target files to be created with a suffix such as "~" and that
     * causes the respective files to be renamed to their target file name after
     * the transfer of all files has been successfully completed. If at least
     * one file out of a set of files cannot be transferred successfully then no
     * files will be renamed, instead the temporarily created files are removed
     * from the target system. The parameter remove_files that causes files to
     * be removed after successful transfer will be effective only after all
     * files have been successfully transferred. Otherwise no files will be
     * removed. */
     ...
     *
     * Transfer mode is used for FTP exclusively and can be either ascii or
     * binary. */
     ...
     *
     * The verbosity level specifies the intensity of log entries. A value
     * between 1 and 9 can be specified. Higher values cause more detailed
    ...
    /** \var zero_byte_transfer : This parameter specifies whether zero byte
     * files This parameter specifies whether zero byte files should be
     * transferred and processed by subsequent commands. The following settings
     * are available: yes : Files with zero byte size are transferred (default).
     * no : Files with zero byte size are transferred, should at least one of
     * the files have more than zero byte size. strict : Files with zero byte
     * size are not transferred. An error will be raised if any zero byte file
     * is found. relaxed : Files with zero byte size will not be transferred.
     * However, no error will be raised if this results in no files being
     * transferred. */

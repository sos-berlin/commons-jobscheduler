...
public interface ISOSVfsFileTransfer {
    ...
    /** reconnect the connection to the server if client is currently not
     * connected.
     * 
     * @param options */
     ...
     *
     * \details This Method is used to set the encoding-type, e.g. utf-8 or
     * iso-8850-1, used by the (ftp-)server.
     *
     * \return void
     *

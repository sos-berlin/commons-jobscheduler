...
public interface ISOSShellOptions {
     ...
     * \details setter
     *
     * @param simulateShellInactivityTimeout the value for
     *            simulate_shell_inactivity_timeout to set */
     ...
     * \details setter
     *
     * @param simulateShellLoginTimeout the value for
     *            simulate_shell_login_timeout to set */
     ...
     * \details setter
     *
     * @param simulateShellPromptTrigger the value for
     *            simulate_shell_prompt_trigger to set */

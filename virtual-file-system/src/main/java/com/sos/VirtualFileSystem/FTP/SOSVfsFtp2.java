...
public class SOSVfsFtp2 extends SOSVfsFtpBaseClass2 implements ISOSVfsFileTransfer, ISOSVFSHandler, ISOSVirtualFileSystem, ISOSConnection {
    ...
    @Override
    @Deprecated
    // use getFilenames in superclass
    ...
    // private Vector<String> getFilenames(final String pstrPathName, final
    // boolean flgRecurseSubFolders) {
    //
    ...
    // if (isNotHiddenFile(strCurrentFile) && strCurrentFile.trim().length() >
    // 0) {

...
public abstract class SOSFilterOptionsSuperClass extends JSOptionsClass {
	...
	/**
	 * \option Line_numbering_position
	 * \type SOSOptionInteger
	 * \brief Line_numbering_position - Insert line number at position
	 *
	 * \details
	 ...
	 */
	@JSOptionDefinition(
						name = "Line_numbering_position",
						description = "Insert line number at position",
						key = "Line_numbering_position",
	...
	public SOSOptionInteger	Line_numbering_position	= new SOSOptionInteger( // ...
														...
														false);
																...
																public SOSOptionInteger getLine_numbering_position() {
																	@SuppressWarnings("unused") final String conMethodName = conClassName + "::getLine_numbering_position";
																...
																public SOSFilterOptionsSuperClass setLine_numbering_position(final SOSOptionInteger pstrValue) {
																	@SuppressWarnings("unused") final String conMethodName = conClassName + "::setLine_numbering_position";
																	Line_numbering_position = pstrValue;
																	return this;
																} // public SOSFilterOptionsSuperClass setLine_numbering_position

	/**
	 * \option Line_Numbering_Format
	 * \type SOSOptionString
	 * \brief Line_Numbering_Format - Format mask of line numbering value
	 *
	 * \details
	 ...
	 */
	@JSOptionDefinition(
						name = "Line_Numbering_Format",
						description = "Format mask of line numbering value",
						key = "Line_Numbering_Format",
	...
	public SOSOptionString getLine_Numbering_Format() {
		@SuppressWarnings("unused") final String conMethodName = conClassName + "::getLine_Numbering_Format";
	...
	public SOSFilterOptionsSuperClass setLine_Numbering_Format(final SOSOptionString pstrValue) {
		@SuppressWarnings("unused") final String conMethodName = conClassName + "::setLine_Numbering_Format";
		Line_Numbering_Format = pstrValue;
		return this;
	} // public SOSFilterOptionsSuperClass setLine_Numbering_Format
	/**
	 * \option Line_Numbering_Increment_Value
	 * \type SOSOptionInteger
	 * \brief Line_Numbering_Increment_Value - Increment value for line-numbering
	 *
	 * \details
	 ...
	 */
	@JSOptionDefinition(
						name = "Line_Numbering_Increment_Value",
						description = "Increment value for line-numbering",
						key = "Line_Numbering_Increment_Value",
						type = "SOSOptionInteger",
						mandatory = false)
	...
	public SOSOptionInteger getLine_Numbering_Increment_Value() {
		@SuppressWarnings("unused") final String conMethodName = conClassName + "::getLine_Numbering_Increment_Value";
	...
	public SOSFilterOptionsSuperClass setLine_Numbering_Increment_Value(final SOSOptionInteger pstrValue) {
		@SuppressWarnings("unused") final String conMethodName = conClassName + "::setLine_Numbering_Increment_Value";
		Line_Numbering_Increment_Value = pstrValue;
		return this;
	} // public SOSFilterOptionsSuperClass setLine_Numbering_Increment_Value
	/**
	 * \option Line_numbering_start_value
	 * \type SOSOptionInteger
	 * \brief Line_numbering_start_value - STart value for line numbering
	 *
	 * \details
	 ...
	 */
	@JSOptionDefinition(
						name = "Line_numbering_start_value",
						description = "STart value for line numbering",
						key = "Line_numbering_start_value",
						type = "SOSOptionInteger",
						mandatory = false)
	...
	public SOSOptionInteger getLine_numbering_start_value() {
		@SuppressWarnings("unused") final String conMethodName = conClassName + "::getLine_numbering_start_value";
	...
	public SOSFilterOptionsSuperClass setLine_numbering_start_value(final SOSOptionInteger pstrValue) {
		@SuppressWarnings("unused") final String conMethodName = conClassName + "::setLine_numbering_start_value";
		Line_numbering_start_value = pstrValue;
		return this;
	} // public SOSFilterOptionsSuperClass setLine_numbering_start_value
	/**
	 * \option create_line_numbers
	 * \type SOSOptionBoolean
	 * \brief create_line_numbers - Create line number for all lines of a file
	 *
	 * \details
	 ...
	 */
	@JSOptionDefinition(
						name = "create_line_numbers",
						description = "Create line number for all lines of a file",
						key = "create_line_numbers",
	...
	public SOSOptionBoolean getcreate_line_numbers() {
		@SuppressWarnings("unused") final String conMethodName = conClassName + "::getcreate_line_numbers";
	...
	public SOSFilterOptionsSuperClass setcreate_line_numbers(final SOSOptionBoolean pstrValue) {
		@SuppressWarnings("unused") final String conMethodName = conClassName + "::setcreate_line_numbers";
		create_line_numbers = pstrValue;
		return this;
	} // public SOSFilterOptionsSuperClass setcreate_line_numbers
	/**
	 * \option renumber_lines
	 * \type SOSOptionBoolean
	 * \brief renumber_lines - Make a renumbering of all lines in a file
	 *
	 * \details
	...
	@JSOptionDefinition(
						name = "renumber_lines",
						description = "Make a renumbering of all lines in a file",
						key = "renumber_lines",
						type = "SOSOptionBoolean",
						mandatory = false)
	...
	public SOSOptionBoolean getrenumber_lines() {
		@SuppressWarnings("unused") final String conMethodName = conClassName + "::getrenumber_lines";
	...
	public SOSFilterOptionsSuperClass setrenumber_lines(final SOSOptionBoolean pstrValue) {
		@SuppressWarnings("unused") final String conMethodName = conClassName + "::setrenumber_lines";
	...
	@JSOptionDefinition(
						...
						description = "Filter definitions: what to process and in what sequence",
						key = "Filter_sequence",
	...
	public String getFilter_sequence() {
		@SuppressWarnings("unused") final String conMethodName = conClassName + "::getFilter_sequence";
		return FilterSequence.Value();
	} // public String getFilter_sequence

	public SOSFilterOptionsSuperClass setFilter_sequence(final String pstrValue) {
		@SuppressWarnings("unused") final String conMethodName = conClassName + "::setFilter_sequence";
	...
	@JSOptionDefinition(
						name = "do_replacing",
						description = "Activate replacing",
						key = "do_replacing",
						type = "SOSOptionBoolean",
						mandatory = false)
	...
	public String getdo_replacing() {
		@SuppressWarnings("unused") final String conMethodName = conClassName + "::getdo_replacing";
		return doReplacing.Value();
	} // public String getdo_replacing

	public SOSFilterOptionsSuperClass setdo_replacing(final String pstrValue) {
		@SuppressWarnings("unused") final String conMethodName = conClassName + "::setdo_replacing";
	...
	public String getreplace_what() {
		@SuppressWarnings("unused") final String conMethodName = conClassName + "::getreplace_what";
		return replaceWhat.Value();
	} // public String getreplace_what

	public SOSFilterOptionsSuperClass setreplace_what(final String pstrValue) {
		@SuppressWarnings("unused") final String conMethodName = conClassName + "::setreplace_what";
	...
	public String getreplace_with() {
		@SuppressWarnings("unused") final String conMethodName = conClassName + "::getreplace_with";
		return replaceWith.Value();
	} // public String getreplace_with

	public SOSFilterOptionsSuperClass setreplace_with(final String pstrValue) {
		@SuppressWarnings("unused") final String conMethodName = conClassName + "::setreplace_with";
	 ...
	 */
	@JSOptionDefinition(
						name = "exclude_lines_before",
						description = "exclude_lines_before",
						key = "exclude_lines_before",
						type = "SOSOptionRegExp",
						mandatory = false)
	...
	public String getexclude_lines_before() {
		@SuppressWarnings("unused") final String conMethodName = conClassName + "::getexclude_lines_before";
		return excludeLinesBefore.Value();
	} // public String getexclude_lines_before

	public SOSFilterOptionsSuperClass setexclude_lines_before(final String pstrValue) {
		@SuppressWarnings("unused") final String conMethodName = conClassName + "::setexclude_lines_before";
	 ...
	 */
	@JSOptionDefinition(
						name = "exclude_lines_after",
						description = "exclude_lines_after",
						key = "exclude_lines_after",
						type = "SOSOptionRegExp",
						mandatory = false)
	...
	public String getexclude_lines_after() {
		@SuppressWarnings("unused") final String conMethodName = conClassName + "::getexclude_lines_after";
		return exclude_lines_after.Value();
	} // public String getexclude_lines_after

	public SOSFilterOptionsSuperClass setexclude_lines_after(final String pstrValue) {
		@SuppressWarnings("unused") final String conMethodName = conClassName + "::setexclude_lines_after";
	...
	public String getexclude_lines() {
		@SuppressWarnings("unused") final String conMethodName = conClassName + "::getexclude_lines";
		return excludeLines.Value();
	} // public String getexclude_lines

	public SOSFilterOptionsSuperClass setexclude_lines(final String pstrValue) {
		@SuppressWarnings("unused") final String conMethodName = conClassName + "::setexclude_lines";
	...
	@JSOptionDefinition(
						...
						description = "exclude empty lines",
						key = "exclude_empty_lines",
						type = "SOSOptionRegExp",
						mandatory = false)
	...
	public String getexclude_empty_lines() {
		@SuppressWarnings("unused") final String conMethodName = conClassName + "::getexclude_empty_lines";
		return excludeEmptyLines.Value();
	} // public String getexclude_empty_lines

	public SOSFilterOptionsSuperClass setexclude_empty_lines(final String pstrValue) {
		@SuppressWarnings("unused") final String conMethodName = conClassName + "::setexclude_empty_lines";
	...
	public String getinclude_lines() {
		@SuppressWarnings("unused") final String conMethodName = conClassName + "::getinclude_lines";
		return includeLines.Value();
	} // public String getinclude_lines

	public SOSFilterOptionsSuperClass setinclude_lines(final String pstrValue) {
		@SuppressWarnings("unused") final String conMethodName = conClassName + "::setinclude_lines";

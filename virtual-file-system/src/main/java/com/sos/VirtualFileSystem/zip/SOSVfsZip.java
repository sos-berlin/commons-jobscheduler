 ...
 * \author KB
 * 
 * @version $Id$23.08.2010 \see reference
 *
...
public class SOSVfsZip extends SOSVfsBaseClass implements ISOSVfsFileTransfer, ISOSVFSHandler, ISOSVirtualFileSystem, ISOSConnection {
    ...
    private String getRealFileName(final String pstrPathname) {
        // TODO use objWorkingDirectory if it is not null to determine the
        // Directory
        return pstrPathname;
    }
    ...
    /** \brief mkdir
     *
     * \details Create a new (sub-)Folder inside the ZIP-File.
     *
     * \return
     *
     * @param pathname
    ...
    public ISOSVirtualFile getFileHandle(final String pstrFileName) {
        ...
        /** the java-zip paket is not able to store utf-encoded characters but
         * this translation will more or less getting deeper into problems */
        // byte[] iso88591Data = pstrFileName.getBytes(Charset.forName
        // ("UTF-8"));
        // String strEncodedEntryName = new String(iso88591Data, Charset.forName
        // ("ISO-8859-1"));

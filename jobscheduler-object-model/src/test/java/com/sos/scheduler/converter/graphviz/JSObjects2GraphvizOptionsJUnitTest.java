 ...
 * ("		JSObjects2GraphvizOptionsJUnitTest.auth_file", "test"); // This parameter
...
public class JSObjects2GraphvizOptionsJUnitTest extends JSToolBox {
    ...
    public void testlive_folder_name() {  // SOSOptionString
        ...
        // Value Method of SOSOptionFolderName adds a "/" if missing, so it has
        // to be added to the expected Result also

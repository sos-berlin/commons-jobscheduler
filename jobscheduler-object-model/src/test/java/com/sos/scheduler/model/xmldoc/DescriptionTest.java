 ...
 * ---------------------------------------------------------------------------
 * </p>
 * \author Uwe Risse \version 09.03.2011 \see reference
 *
...
public class DescriptionTest {
    ...
    /** Test method for
     * {@link com.sos.scheduler.model.xmldoc.Description#getJob()}.
     * 
    ...
    /** Test method for
     * {@link com.sos.scheduler.model.xmldoc.Description#setJob(com.sos.scheduler.model.xmldoc.Description.Job)}
     * .
     * 
     * @throws JAXBException */
    @Test
    ...
    public void testSetJob() throws JAXBException {
        // reading existing file, changing values, writing new file, reading
        // again, test values.
    ...
    /** Test method for
     * {@link com.sos.scheduler.model.xmldoc.Description#getReleases()}.
     * 
     * @throws JAXBException */
    @Test
    @Ignore("Test set to Ignore for later examination")
    ...
    /** Test method for
     * {@link com.sos.scheduler.model.xmldoc.Description#setReleases(com.sos.scheduler.model.xmldoc.Description.Releases)}
     * .
     * 
     * @throws JAXBException
    ...
    public void testSetReleases() throws JAXBException, DatatypeConfigurationException {
        // reading existing file, adding release, setting values, writing new
        // file, reading again, test values.
        ...
        for (int i = 1; i < list.size(); i++) {
            ...
            for (int ii = 0; ii < list_note.size(); ii++) {
                ...
                /*
                 * ArrayList<Object> list_content =
                 * (ArrayList<Object>)n.getContent(); for (int iii=0;iii <
                 * list_content.size();iii++){ list_content.get(1).getClass();
                 * Object o = list_content.get(1); str = o.toString();
                 * assertEquals
                 * ("Releases.Release.Note.Content must be [div: null]",
                 * "[div: null]" ,str); }
                 */
            }
        }
    ...
    /** Test method for
     * {@link com.sos.scheduler.model.xmldoc.Description#getResources()}.
     * 
     * @throws JAXBException */
    @Test
    @Ignore("Test set to Ignore for later examination")
    ...
    /** Test method for
     * {@link com.sos.scheduler.model.xmldoc.Description#setResources(com.sos.scheduler.model.xmldoc.Description.Resources)}
     * .
     * 
     * @throws JAXBException */
    @Test
    ...
    public void testSetResources() throws JAXBException {
        // reading existing file, adding resouce, setting values, writing new
        // file, reading again, test values.
    ...
    /** Test method for
     * {@link com.sos.scheduler.model.xmldoc.Description#getConfiguration()}.
     * 
     * @throws Exception */
    @Test
    @Ignore("Test set to Ignore for later examination")
    public void testGetConfiguration() throws Exception {
        ...
        // @FIXME The method writeDocument(String) is undifined for the type
        // JSXMLFile
    ...
    /** Test method for
     * {@link com.sos.scheduler.model.xmldoc.Description#setConfiguration(com.sos.scheduler.model.xmldoc.Description.Configuration)}
     * . */
    @Test
    @Ignore
    ...
    /** Test method for
     * {@link com.sos.scheduler.model.xmldoc.Description#getDocumentation()}. */
    @Test
    @Ignore

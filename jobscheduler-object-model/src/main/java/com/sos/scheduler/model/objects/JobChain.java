...
@XmlType(name = "", propOrder = { "note", "jobChainNodeJobChain", "jobChainNodeJobChainOrJobChainNodeEnd", "fileOrderSource",
...
public class JobChain extends JSObjBase {
    ...
    @XmlElements({ @XmlElement(name = "job_chain_node.end", type = JobChainNodeEnd.class),
    ...
    @XmlElements({ @XmlElement(name = "file_order_sink", type = JobChain.FileOrderSink.class),
            @XmlElement(name = "job_chain_node", type = JobChain.JobChainNode.class), @XmlElement(name = "job_chain_node.end", type = JobChainNodeEnd.class) })
     ...
     * {@link JobChainNodeEnd } {@link JobChainNodeJobChain } */
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link JobChain.FileOrderSink } {@link JobChain.JobChainNode }
     ...
     * </pre> */
    @XmlAccessorType(XmlAccessType.FIELD)
    @XmlType(name = "", propOrder = { "extensions", "any" })

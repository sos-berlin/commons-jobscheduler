...
public enum UnixSignalName {
    ...
    SIGHUP("SIGHUP"), SIGINT("SIGINT"), SIGQUIT("SIGQUIT"), SIGILL("SIGILL"), SIGTRAP("SIGTRAP"), SIGABRT("SIGABRT"), SIGIOT("SIGIOT"), SIGBUS("SIGBUS"), SIGFPE(
            "SIGFPE"), SIGKILL("SIGKILL"), @XmlEnumValue("SIGUSR1")

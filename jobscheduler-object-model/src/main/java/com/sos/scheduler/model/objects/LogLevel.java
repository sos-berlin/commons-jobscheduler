...
public enum LogLevel {
    ...
    @XmlEnumValue("error")
    ERROR("error"), @XmlEnumValue("warn")
    WARN("warn"), @XmlEnumValue("info")
    INFO("info"), @XmlEnumValue("debug")
    DEBUG("debug"), @XmlEnumValue("debug1")
    DEBUG_1("debug1"), @XmlEnumValue("debug2")
    DEBUG_2("debug2"), @XmlEnumValue("debug3")
    DEBUG_3("debug3"), @XmlEnumValue("debug4")
    DEBUG_4("debug4"), @XmlEnumValue("debug5")
    DEBUG_5("debug5"), @XmlEnumValue("debug6")
    DEBUG_6("debug6"), @XmlEnumValue("debug7")
    DEBUG_7("debug7"), @XmlEnumValue("debug8")
    DEBUG_8("debug8"), @XmlEnumValue("debug9")
    DEBUG_9("debug9");

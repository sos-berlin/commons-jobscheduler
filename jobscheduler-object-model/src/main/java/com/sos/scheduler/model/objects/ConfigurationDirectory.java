...
/** <p>
 * Java class for configuration.directory complex type.
 * 
 * <p>
...
@XmlType(name = "configuration.directory", propOrder = { "configurationDirectoryOrConfigurationFile" })
public class ConfigurationDirectory extends JSObjBase {

    @XmlElements({ @XmlElement(name = "configuration.file", type = ConfigurationFile.class),
     ...
     * <CODE>set</CODE> method for the configurationDirectoryOrConfigurationFile
     * property.
     * 
     * <p>
     ...
     * {@link ConfigurationFile } {@link ConfigurationDirectory } */

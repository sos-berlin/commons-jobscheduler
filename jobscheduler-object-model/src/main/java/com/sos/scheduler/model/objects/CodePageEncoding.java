...
/** <p>
 * Java class for Code_page_encoding.
 * 
 * <p>
...
public enum CodePageEncoding {
    ...
    @XmlEnumValue("oem")
    OEM("oem"), @XmlEnumValue("cp437")
    CP_437("cp437"), @XmlEnumValue("cp850")
    CP_850("cp850"), @XmlEnumValue("latin1")
    LATIN_1("latin1"), @XmlEnumValue("none")
    NONE("none");

...
public class Folder implements Serializable {
	...
	@XmlElements({
        @XmlElement(name = "file_based", type = FileBased.class),
        @XmlElement(name = "job_chains", type = JobChains.class),
        @XmlElement(name = "folders", type = Folders.class),
        @XmlElement(name = "process_classes", type = ProcessClasses.class),
        @XmlElement(name = "orders", type = Orders.class),
        @XmlElement(name = "locks", type = Locks.class),
     ...
     * This is why there is not a <CODE>set</CODE> method for the fileBasedOrJobsOrFolders property.
     * 
     * <p>

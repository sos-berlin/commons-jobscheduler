...
/** \class JobSchedulerLaunchAndObserveOptionsJUnitTest - Launch and observe any
 * given job or job chain
 *
 * \brief
 *
 *
 ...
 * http://www.sos-berlin.com at 20111124185124 \endverbatim
 *
 ...
 * ("		JobSchedulerLaunchAndObserveOptionsJUnitTest.auth_file", "test"); // This
...
public class JobSchedulerLaunchAndObserveOptionsJUnitTest extends JSToolBox {
    ...
    /** \brief testcheck_interval : This parameter specifies the interval in
     * seconds
     * 
     ...
     * 
     * \details This value of this parameter defines wether the job which has to
     * be observed, should be restarted during the observation period, in case
     * the job has ended. */
    @Test
    ...
    /** \brief testscheduler_host : This parameter specifies the host name or IP
     * addre
     * 
    ...
    /** \brief testscheduler_port : The TCP-port for which a JobScheduler, see
     * parameter sche
     * 
     * \details The TCP-port for which a JobScheduler, see parameter
     * scheduler_host. */
    @Test

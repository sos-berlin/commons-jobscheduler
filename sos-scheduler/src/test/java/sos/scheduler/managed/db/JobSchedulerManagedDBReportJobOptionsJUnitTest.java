 ...
 * http://www.sos-berlin.com at 20120830214631 \endverbatim
 *
 ...
 * ("		JobSchedulerManagedDBReportJobOptionsJUnitTest.auth_file", "test"); //
...
public class JobSchedulerManagedDBReportJobOptionsJUnitTest extends JSToolBox {
    ...
    /** \brief testdatabase_connection : database connection from table
    ...
    /** \brief testMax_No_Of_Records_To_Process : Max Number of lines in the
    ...
    /** \brief testscheduler_order_report_mailto : report_mailto: recipients of a
     * report
     * 

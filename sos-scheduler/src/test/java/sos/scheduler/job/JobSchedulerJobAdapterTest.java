...
public class JobSchedulerJobAdapterTest {
    ...
    public void testStringSubstitutorRecursive2() {
        ...
        // "The ${animal-${number}} jumped over the ${target}. ${missingnumner:-47110815}. ${java.version], ${os.name}";
    ...
    public final void testGetSchedulerParameterAsProperties2() {
        ...
        // HashMap<String, String> objHM2 =
        // objJA.getSchedulerParameterAsProperties((HashMap<String, String>)
        // objHM);
        // System.out.println(objHM2.toString());

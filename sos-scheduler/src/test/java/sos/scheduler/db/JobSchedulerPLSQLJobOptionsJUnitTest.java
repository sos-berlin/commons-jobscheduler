 ...
 * http://www.sos-berlin.com at 20120905153725 \endverbatim
 *
 ...
 * ("		JobSchedulerPLSQLJobOptionsJUnitTest.auth_file", "test"); // This
...
public class JobSchedulerPLSQLJobOptionsJUnitTest extends JSToolBox {
    ...
    // private final String strKeePathDBPathName =
    // "../../commons/credentialstore/src/test/resources/keepassX-test.kdb";
    ...
    // assertEquals("source_CredentialStore_use_credential_Store",
    // strKeePathDBPathName, objCS.CredentialStore_FileName.Value());
    // }
    // catch (Exception e) {
    // e.printStackTrace();
    // throw e;
    ...
    /** \brief testcommand : Database Commands for the Job. It is possible to
     * define m
     * 
    ...
    /** \brief testexec_returns_resultset : If stored procedures are called which
     * return a result set
     * 
    ...
    @Test
    public void testexec_returns_resultset() { // SOSOptionString
    ...
    /** \brief testresultset_as_parameters : false No output parameters are
     * generated.
     * 
    ...
    @Test
    public void testresultset_as_parameters() { // SOSOptionString
    ...
    /** \brief testresultset_as_warning : If set to true, a warning will be
     * issued, if the statemen
     * 
     * \details If set to true, a warning will be issued, if the statements
     * produce a result */
    @Test
    public void testresultset_as_warning() { // SOSOptionString

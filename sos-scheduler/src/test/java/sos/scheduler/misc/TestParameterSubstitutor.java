...
public class TestParameterSubstitutor {
    ...
    public void testReplaceInFile() throws IOException {
        ...
        File in = new File("C:/development_110/products/jitl/jitl-jobs/src/test/java/com/sos/jitl/agentbatchinstaller/jobscheduler_universal_agent_batch_install/batch_install/jobscheduler_agent_instance_script.txt");

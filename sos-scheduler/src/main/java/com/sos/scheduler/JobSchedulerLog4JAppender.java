 ...
 *
 * \brief JobSchedulerLog4JAppender - Redirect Log4J-Messages to
 * SOSSchedulerLogger
 *
 * \details This Class acts as a redirection for all Log4J-Messages to the
 * JobScheduler Logger.
 *
 *
 ...
 * \author KB
 * 
 * @version $Id: JobSchedulerLog4JAppender.java 20890 2013-08-21 16:35:10Z kb
 *          $13.06.2010 \see reference
 *
...
public class JobSchedulerLog4JAppender extends ConsoleAppender implements IJobSchedulerLoggingAppender {
     ...
     * (non-Javadoc)
     * @see
     * com.sos.scheduler.IJobSchedulerLoggingAppender#setSchedulerLogger(sos
     * .util.SOSSchedulerLogger)
     */

...
public class JobSchedulerJobAdapter extends JobSchedulerJob
	...
	protected HashMap<String, String> getSchedulerParameterAsProperties(
			final HashMap<String, String> pSchedulerParameterSet) {
	...
	private HashMap<String, String> deleteCurrentNodeNameFromKeys(
			final HashMap<String, String> pSchedulerParameterSet) {
	...
	public HashMap<String, String> testDeleteCurrentNodeNameFromKeys(
			final HashMap<String, String> pSchedulerParameterSet) {

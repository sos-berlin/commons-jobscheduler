    ...
    public void getTaskParameters(boolean logValue) throws Exception {
        ...
        try {
            ...
            if (spooler_task.params().var("scheduler_remote_order_replace") != null
                    && spooler_task.params().var("scheduler_remote_order_replace").length() > 0) {
            ...
            if (spooler_task.params().var("scheduler_remote_order_state") != null
                    && spooler_task.params().var("scheduler_remote_order_state").length() > 0) {
            ...
            if (spooler_task.params().var("scheduler_remote_order_title") != null
                    && spooler_task.params().var("scheduler_remote_order_title").length() > 0) {
    ...
    public boolean spooler_process() {
        ...
        try {
            if (listOfSignalObject.hasNext()) {
                ...
                if ((sosString.parseToString(getHost()).length() == 0 || sosString.parseToString(getHost()).equalsIgnoreCase("localhost"))
                        && getPort() == 4444) {

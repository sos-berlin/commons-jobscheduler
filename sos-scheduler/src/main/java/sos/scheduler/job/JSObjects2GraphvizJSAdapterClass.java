...
/** \class JSObjects2GraphvizJSAdapterClass - JobScheduler Adapter for
 * "JSObjects2Graphviz"
 *
 * \brief AdapterClass of JSObjects2Graphviz for the SOSJobScheduler
 *
 * This Class JSObjects2GraphvizJSAdapterClass works as an adapter-class between
 * the SOS JobScheduler and the worker-class JSObjects2Graphviz.
 *
 * 
 *
 * see \see
 ...
 * \config\JOETemplates\java\xsl\JSJobDoc2JSAdapterClass.xsl from

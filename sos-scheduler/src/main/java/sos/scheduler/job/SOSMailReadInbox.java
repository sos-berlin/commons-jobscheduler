...
public class SOSMailReadInbox extends Job_impl {
    ...
    /** Settings Attribut: mailDumpDir: Verzeichnis für Email, die als Datei
     * gespeichert werden */
    ...
    /** Settings Attribut: mailSchedulerHost: Scheduler Host für Kommando aus
     * Body und add_order */
    private String mailSchedulerHost = "";
    /** Settings Attribut: mailSchedulerPort: Scheduler Port für Kommando aus
     * Body und add_order */

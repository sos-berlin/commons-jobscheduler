/*
 * JobSchedulerShowParams.java Created on 06.04.2005
 */
...
public class JobSchedulerShowParams extends JobSchedulerJob {
    ...
    public boolean spooler_process() {
        boolean rc = false;
        // classic or order queue driven? return true for order queue driven
        // invocation, return false for classic job start
    ...
    /** This method returns the params Variable_set with cleaned up password
     * parameters to prevent security Issues
     * 
     * @param originalParams the Variable_set which can contain clear type
     *            passwords

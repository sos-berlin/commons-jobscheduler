...
public class JobSchedulerMailJob extends JobSchedulerJob {
            ...
            try { // to create settings instance if a connection was given
                if (this.getConnection() != null && this.hasDatabase()) {
                    ...
                    if (this.sosMailSettings.getSectionEntry("queue_prefix") != null
                            && this.sosMailSettings.getSectionEntry("queue_prefix").length() > 0) {
                    ...
                    if (this.sosMailSettings.getSectionEntry("queue_directory") != null
                            && this.sosMailSettings.getSectionEntry("queue_directory").length() > 0) {
                    ...
                    if (this.sosMailSettings.getSectionEntry("log_directory") != null
                            && this.sosMailSettings.getSectionEntry("log_directory").length() > 0) {
                    ...
                    if (this.sosMailSettings.getSectionEntry("mail_log_only") != null
                            && this.sosMailSettings.getSectionEntry("mail_log_only").length() > 0) {
                    ...
                    if (this.sosMailSettings.getSectionEntry("max_delivery") != null
                            && this.sosMailSettings.getSectionEntry("max_delivery").length() > 0) {
    ...
    /** @param applicationMailTemplatesFactory The applicationMailTemplatesFactory
     *            to set. */

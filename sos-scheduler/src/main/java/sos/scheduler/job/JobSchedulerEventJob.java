...
public class JobSchedulerEventJob extends JobSchedulerJob {
                    ...
                    for (int i = 0; i < commands.getLength(); i++) {
                        ...
                        try {
                            ...
                            for (int k = 0; k < commandElements.getLength(); k++) {
                                ...
                                this.getLogger().info(
                                        ".. sending command to remote JobScheduler [" + commandHost + ":" + commandPort + "]: " + commandRequest);
    ...
    private void addEvent(final Element event, final boolean replace) throws Exception {
        ...
        try {
            ...
            this.getLogger().info(
                    ".. adding event ...: scheduler id=" + curEventSchedulerId + ", event class=" + curEventClass + ", event id=" + curEventId

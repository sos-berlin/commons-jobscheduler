...
/** This class can be used to store Java Objects in Job Scheduler Variables.<br>
 * The objects need to be serializable.<br>
 * Objects can be stored in task, order or global Scheduler variables. Note that
 * global Scheduler variables are not persistent.
 *

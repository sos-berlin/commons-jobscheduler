...
/** \class SOSSQLPlusJobJSAdapterClass - JobScheduler Adapter for
 * "Start SQL*Plus client and execute sql*plus programs"
 *
 * \brief AdapterClass of SOSSQLPlusJob for the SOSJobScheduler
 *
 * This Class SOSSQLPlusJobJSAdapterClass works as an adapter-class between the
 * SOS JobScheduler and the worker-class SOSSQLPlusJob.
 *
 * 
 *
 * see \see
 ...
 * Kopie\xsl\JSJobDoc2JSAdapterClass.xsl from http://www.sos-berlin.com at
 * 20120927164006 \endverbatim */

 ...
 * by the "real" Options-class (\see JobSchedulerPLSQLJobOptions. The "real"
 ...
 * 20120905153339 \endverbatim \section OptionsTable Tabelle der vorhandenen
 * Optionen
 * 
 ...
 * ("		JobSchedulerPLSQLJobOptionsSuperClass.auth_file", "test"); // This
...
public class JobSchedulerPLSQLJobOptionsSuperClass extends JSOptionsClass implements ISOSCredentialStoreOptionsBridge {
     ...
     * Database Commands for the Job. It is possible to define more than one
     * instruction in the COMMAND field. Such instructions are then carried out
     * in the order in which they are written and must be separated by a
     * semicolon and a subsequent new line. Parameters can be replaced in
    ...
    /** \brief getcommand : Database Commands for the Job. It is possible to
     * define m
     * 
     ...
     * by a semicolon and a subsequent new line. Parameters can be replaced in
     * database commands. This is done by the addition of a variable in the form
     * §{param} at any given point in a command. This variable is then given the
     * value of the instruction parameter with the name [param] before
     * execution.
    ...
    /** \brief setcommand : Database Commands for the Job. It is possible to
     * define m
     * 
     * \details Database Commands for the Job. It is possible to define more
     * than one instruction in the COMMAND field. Such instructions are then
     ...
     * execution.
     *
     * @param command : Database Commands for the Job. It is possible to define
     *            m */
    ...
    /** \var db_url : jdbc url (e.g. jdbc:oracle:thin:@localhost:1521:XE) jdbc
    ...
    /** \var exec_returns_resultset : If stored procedures are called which
     * return a result set If stored procedures are called which return a result
     * set, this needs to be set to true in order to run the stored procedure as
     * a query. This does not work with the SQL Server 2000 and 2005 jdbc
     * drivers. */
    ...
    /** \brief getexec_returns_resultset : If stored procedures are called which
     * return a result set
     * 
    ...
    /** \brief setexec_returns_resultset : If stored procedures are called which
     * return a result set
     * 
     * \details If stored procedures are called which return a result set, this
     * needs to be set to true in order to run the stored procedure as a query.
     * This does not work with the SQL Server 2000 and 2005 jdbc drivers.
     *
     * @param exec_returns_resultset : If stored procedures are called which
     *            return a result set */
     ...
     * false No output parameters are generated. true If set to true, the first
     * row of the resultset will be set as order parameters (using the column
     * names as parameter names). Example: The query
     * "SELECT first_name, last_name, age FROM persons" produces the following
     * result set: first_name last_name age John Doe 30 Hans Mustermann 33 Jean
     * Dupont 56 The following name/value pairs will be generated as order
     * parameters: first_name=John last_name=Doe age=30 name_value If set to
     * name_value, the first two columns of the resultset will be turned into
     * order parameters. The values of the first column will become parameter
     * names, the values of the second column will become parameter values.
     * Example: From the above resultset, the following name/value pairs will be
     * generated as order parameters: John=Doe Hans=Mustermann Jean=Dupont */
    ...
    /** \brief getresultset_as_parameters : false No output parameters are
     * generated.
     * 
     * \details false No output parameters are generated. true If set to true,
     * the first row of the resultset will be set as order parameters (using the
     * column names as parameter names). Example: The query
     * "SELECT first_name, last_name, age FROM persons" produces the following
     * result set: first_name last_name age John Doe 30 Hans Mustermann 33 Jean
     * Dupont 56 The following name/value pairs will be generated as order
     * parameters: first_name=John last_name=Doe age=30 name_value If set to
    ...
    /** \brief setresultset_as_parameters : false No output parameters are
     * generated.
     * 
     * \details false No output parameters are generated. true If set to true,
     * the first row of the resultset will be set as order parameters (using the
     ...
     * generated as order parameters: John=Doe Hans=Mustermann Jean=Dupont
     *
     * @param resultset_as_parameters : false No output parameters are
     *            generated. */
    ...
    /** \var resultset_as_warning : If set to true, a warning will be issued, if
     * the statemen If set to true, a warning will be issued, if the statements
     * produce a result */
    ...
    /** \brief getresultset_as_warning : If set to true, a warning will be
     * issued, if the statemen
     * 
     * \details If set to true, a warning will be issued, if the statements
     * produce a result
     *
    ...
    /** \brief setresultset_as_warning : If set to true, a warning will be
     * issued, if the statemen
     * 
     * \details If set to true, a warning will be issued, if the statements
     * produce a result
     *
     * @param resultset_as_warning : If set to true, a warning will be issued,
     *            if the statemen */

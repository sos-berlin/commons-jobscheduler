...
/** \class SOSSQLPlusJobOptionsSuperClass - Start SQL*Plus client and execute
 * sql*plus programs
 *
 * \brief An Options-Super-Class with all Options. This Class will be extended
 * by the "real" Options-class (\see SOSSQLPlusJobOptions. The "real" Option
 ...
 * 20120927163810 \endverbatim \section OptionsTable Tabelle der vorhandenen
 * Optionen
 *
 ...
 * ("		SOSSQLPlusJobOptionsSuperClass.auth_file", "test"); // This parameter
...
public class SOSSQLPlusJobOptionsSuperClass extends JSOptionsClass implements ISOSCmdShellOptions, ISOSCredentialStoreOptionsBridge {
    ...
    /** \option Start_Shell_command \type SOSOptionString \brief
     * Start_Shell_command - Command to start a command shell
     *
     * \details Command to start a command shell
     *
     * \mandatory: false
     *
    ...
    public SOSOptionString getStart_Shell_command() {
        ...
        @SuppressWarnings("unused")
        final String conMethodName = conClassName + "::getStart_Shell_command";
    ...
    public void setStart_Shell_command(final SOSOptionString pstrValue) {
        ...
        @SuppressWarnings("unused")
        final String conMethodName = conClassName + "::setStart_Shell_command";
        Start_Shell_command = pstrValue;
    } // public SOSSQLPlusJobOptionsSuperClass setStart_Shell_command

    /** \option OS_Name \type SOSOptionString \brief OS_Name - Name of
     * Operating-System
     *
     * \details Name of Operating-System
     *
     * \mandatory: false
     *
    ...
    public SOSOptionString getOS_Name() {
        ...
        @SuppressWarnings("unused")
        final String conMethodName = conClassName + "::getOS_Name";
    ...
    public void setOS_Name(final SOSOptionString pstrValue) {
        ...
        @SuppressWarnings("unused")
        final String conMethodName = conClassName + "::setOS_Name";
        OS_Name = pstrValue;
    } // public SOSSQLPlusJobOptionsSuperClass setOS_Name

    /** \option Start_Shell_command_Parameter \type SOSOptionString \brief
     * Start_Shell_command_Parameter - Additional Parameters for
     * Start_Shell_command
     *
     * \details Additional Parameters for Shell command
     *
     * \mandatory: false
     *
     ...
     * (non-Javadoc)
     * @see
     * sos.scheduler.db.ISOSCmdShellOptions#getStart_Shell_command_Parameter()
     */
    @Override
    public SOSOptionString getStart_Shell_command_Parameter() {

        @SuppressWarnings("unused")
        final String conMethodName = conClassName + "::getStart_Shell_command_Parameter";
    ...
    public void setStart_Shell_command_Parameter(final SOSOptionString pstrValue) {
        ...
        @SuppressWarnings("unused")
        final String conMethodName = conClassName + "::setStart_Shell_command_Parameter";
        Start_Shell_command_Parameter = pstrValue;
    } // public SOSSQLPlusJobOptionsSuperClass setStart_Shell_command_Parameter

    /** \option Shell_command_Parameter \type SOSOptionString \brief
     * Shell_command_Parameter - Additional Parameters for Shell_command
     *
     * \details Additional Parameters for Shell command
     *
     * \mandatory: false
    ...
    public SOSOptionString getShell_command_Parameter() {
        ...
        @SuppressWarnings("unused")
        final String conMethodName = conClassName + "::getShell_command_Parameter";
    ...
    public void setShell_command_Parameter(final SOSOptionString pstrValue) {
        ...
        @SuppressWarnings("unused")
        final String conMethodName = conClassName + "::setShell_command_Parameter";
        Shell_command_Parameter = pstrValue;
    } // public SOSSQLPlusJobOptionsSuperClass setShell_command_Parameter

    /** \option ignore_ora_messages \type SOSOptionStringValueList \brief
     * ignore_ora_messages - Ignore ORA Messages
     *
     * \details Ignore ORA MEssages
     *
     * \mandatory: false
     *
    ...
    public String getignore_ora_messages() {
        ...
        @SuppressWarnings("unused")
        final String conMethodName = conClassName + "::getignore_ora_messages";
    ...
    public void setignore_ora_messages(final String pstrValue) {
        ...
        @SuppressWarnings("unused")
        final String conMethodName = conClassName + "::setignore_ora_messages";
        ignore_ora_messages.Value(pstrValue);
    } // public SOSSQLPlusJobOptionsSuperClass setignore_ora_messages

    /** \option ignore_sp2_messages \type SOSOptionValueList \brief
     * ignore_sp2_messages - List of messages to ignore or *all
     *
     * \details List of messages to ignore or *all
     *
     * \mandatory: false
     *
    ...
    public String getignore_sp2_messages() {
        ...
        @SuppressWarnings("unused")
        final String conMethodName = conClassName + "::getignore_sp2_messages";
    ...
    public void setignore_sp2_messages(final String pstrValue) {
        ...
        @SuppressWarnings("unused")
        final String conMethodName = conClassName + "::setignore_sp2_messages";
        ignore_sp2_messages.Value(pstrValue);
    } // public SOSSQLPlusJobOptionsSuperClass setignore_sp2_messages

    /** \var db_url : URL for connection to database jdbc url (e.g. jdbc url
    ...
    /** \var command_script_file : Script file name to Execute The va The value
     * of this parameter contains the file-name (and path-name, if needed) of a
     * local (script-)file, which will be transferred to the remote host and
     * will then be executed there. The script can access job- and
     * order-parameters by environment variables. The names of the environment
     * variables are in upper case and have the string "SCHEDULER_PARAM_" as a
     * prefix. Order parameters with the same name overwrite task parameters.
     * This parameter can be used as an alternative to command ,
     * command_delimiter and command_script . */
     ...
     * (non-Javadoc)
     * @see
     * sos.scheduler.db.ISOSCmdShellOptions#setcommand_script_file(com.sos.JSHelper
     * .Options.SOSOptionCommandString)
     */
    @Override
     ...
     * (non-Javadoc)
     * @see
     * sos.scheduler.db.ISOSCmdShellOptions#setCommand_Line_options(com.sos.
     * JSHelper.Options.SOSOptionString)
     */
    @Override
     ...
     * (non-Javadoc)
     * @see
     * sos.scheduler.db.ISOSCmdShellOptions#setshell_command(com.sos.JSHelper
     * .Options.SOSOptionString)
     */
    @Override

...
/** <p>
 * ASKJob ist die Basisklasse für Job-Implementierungen und stellt Methoden zur
 * Verfügung:
 * </p>
 * <p>
 * - getJobProperties(), getJobSettings(): Lesen von Einstellungen aus
 * Job-Konfigurationsdateien (factory.ini)
 * </p>
 * <p>
 * - getConnection(): Datenbankverbindungen des Jobs
 * </p>
 * <p>
 * - getSchedulerConnection(): Datenbankverbindung des Job Schedulers
 * </p>
 * 
...
public class ProcessJob extends Job_impl {
     ...
     * 
     * @param factoryIni Pfad zur Datei factory.ini (wird von der Methode
     *            ini_path() des spooler Objekts geliefert)
     * @throws Exception */
    ...
    /** Gibt ein SOSConnection Objekt mit der Datenbankverbindung des Job
     * Schedulers zurück. Die Verbindung muss noch mit connect() geöffnet und
     * disconnect() wieder geschlossen werden.
     * 
    ...
    /** Gibt ein SOSConnection Objekt mit der Datenbankverbindung des Job
     * Schedulers zurück. Die Verbindung muss mit connect() geöffnet und
     * disconnect() wieder geschlossen werden.
     * 
     * @param schedulerSettings Settings des Schedulers

...
/** \class JobSchedulerLaunchAndObserveJSAdapterClass - JobScheduler Adapter for
 * "Launch and observe any given job or job chain"
 *
 * \brief AdapterClass of JobSchedulerLaunchAndObserve for the SOSJobScheduler
 *
 * This Class JobSchedulerLaunchAndObserveJSAdapterClass works as an
 * adapter-class between the SOS JobScheduler and the worker-class
 * JobSchedulerLaunchAndObserve.
 *
 * 
 *
 ...
 * http://www.sos-berlin.com at 20111124184800 \endverbatim */

...
/*
This Variables must come with the Base-Class Job_impl or directly specified in the Adapter-Class
due to it's impossible to specifiy Variables in an interface (?)

 ...
 * by the "real" Options-class (\see JSExistsFileOptions. The "real" Option
 ...
 * 20110820120908 \endverbatim \section OptionsTable Tabelle der vorhandenen
 * Optionen
 * 
 ...
 * ("		JSExistsFileOptionsSuperClass.auth_file", "test"); // This parameter
...
public class JSExistsFileOptionsSuperClass extends JSOptionsClass {
    ...
    /** \var count_files : Return the size of resultset If this parameter is set
     * true " true */
    ...
    /** \brief getcount_files : Return the size of resultset If this parameter is
     * set true " true
     * 
     * \details
     * 
    ...
    /** \brief setcount_files : Return the size of resultset If this parameter is
     * set true " true
     * 
     * \details
     * 
     *
     * @param count_files : Return the size of resultset If this parameter is
     *            set true " true */
    ...
    /** \var file_spec : Regular Expression for filename filtering Regular
    ...
    /** \brief getfile_spec : Regular Expression for filename filtering Regular
     * Expression for file fi
     * 
     * \details
     * 
     *
     * \return Regular Expression for filename filtering Regular Expression for
     * file fi */
    public SOSOptionRegExp getfile_spec() {
        return file_spec;
    }

    /** \brief setfile_spec : Regular Expression for filename filtering Regular
     * Expression for file fi
     * 
     * \details
     * 
     *
     * @param file_spec : Regular Expression for filename filtering Regular
     *            Expression for file fi */
    ...
    /** \var gracious : Specify error message tolerance Enables or disables error
     * messages that */
    ...
    /** \brief getgracious : Specify error message tolerance Enables or disables
     * error messages that
     * 
     * \details
     * 
    ...
    /** \brief setgracious : Specify error message tolerance Enables or disables
     * error messages that
     * 
     * \details
     * 
    ...
    /** \var scheduler_sosfileoperations_file_count : Return the size of the
     * result set after a file operation */
    ...
    /** \brief getscheduler_sosfileoperations_file_count : Return the size of the
     * result set after a file operation
     * 
     * \details
     * 
    ...
    /** \brief setscheduler_sosfileoperations_file_count : Return the size of the
     * result set after a file operation
     * 
     * \details
     * 
     *
     * @param scheduler_sosfileoperations_file_count : Return the size of the
     *            result set after a file operation */
    ...
    /** \var scheduler_sosfileoperations_resultset : The result of the operation
     * as a list of items */

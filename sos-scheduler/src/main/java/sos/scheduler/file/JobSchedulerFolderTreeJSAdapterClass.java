...
/** \class JobSchedulerFolderTreeJSAdapterClass - JobScheduler Adapter for
 * "check wether a file exist"
 *
 * \brief AdapterClass of JobSchedulerFolderTree for the SOSJobScheduler
 *
 * This Class JobSchedulerFolderTreeJSAdapterClass works as an adapter-class
 * between the SOS JobScheduler and the worker-class JobSchedulerFolderTree.
 *
 * 
 *
 ...
 * http://www.sos-berlin.com at 20110805104800 \endverbatim */

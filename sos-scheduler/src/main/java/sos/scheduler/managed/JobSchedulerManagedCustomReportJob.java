/*
 * JobSchedulerManagedCustomJob.java Created on 25.10.2005
 */
...
public class JobSchedulerManagedCustomReportJob extends JobSchedulerManagedDatabaseJob {
     ...
     * (non-Javadoc)
     * @see
     * sos.scheduler.managed.JobSchedulerManagedDatabaseJob#executeStatements
     * (sos.connection.SOSConnection, java.lang.String)
     */
    @Override
    protected void executeStatements(final SOSConnection conn, final String command) throws Exception {
         ...
         * fos.write(forerunscript.getBytes()); fos.flush(); fos.close();
         */
        ...
        try {
            ...
            // getLogger().debug6("File exists: "+new
            // File(processor.document_filename()).exists());

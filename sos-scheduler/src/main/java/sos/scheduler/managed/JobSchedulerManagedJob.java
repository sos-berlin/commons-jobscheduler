...
/** Base class for managed jobs. This class can be used to write own mangaged
 * jobs. By calling prepareParams() in spooler_process() task and order
 * parameters will be merged.
 * 

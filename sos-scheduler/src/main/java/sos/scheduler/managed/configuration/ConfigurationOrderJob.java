...
/**
 * <p>ProcessOrderJob ist a baseclass for order jobs with node configuration and provides these functions:</p>
 * <p>- spooler_init(): read stdout und stderr as streams</p>
 * <p>- spooler_exit(): cleanup</p>
 * <p>- executeSubprocess(): execute subprocesses</p>
 * <p>- prepare(), prepareParameters(), prepareAttributes(): merge job an order parameters</p>
 * <p>- initConfiguration(): put XML-configuration file to order xml payload</p>
 * <p>- prepareConfiguration(): puts the xml configuration to order parameters and provides dom</p>
 *
						...
						if (envvars != null) {
							...
							while (envIterator.hasNext()) {
								...
								if (parameterValue.indexOf("${" + envName.toString() + "}") != -1) {
									...
									if (parameterValue.indexOf("${basename:" + envName.toString() + "}") != -1) {

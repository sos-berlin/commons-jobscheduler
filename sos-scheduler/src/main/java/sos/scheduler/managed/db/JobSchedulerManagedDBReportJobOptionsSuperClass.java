...
/** \class JobSchedulerManagedDBReportJobOptionsSuperClass - Launch Database
 * Report
 *
 * \brief An Options-Super-Class with all Options. This Class will be extended
 * by the "real" Options-class (\see JobSchedulerManagedDBReportJobOptions. The
 ...
 * 20120830214156 \endverbatim \section OptionsTable Tabelle der vorhandenen
 * Optionen
 * 
 ...
 * ("		JobSchedulerManagedDBReportJobOptionsSuperClass.auth_file", "test"); //
...
public class JobSchedulerManagedDBReportJobOptionsSuperClass extends JSOptionsClass {
    ...
    /** \var command : Database Commands for the Job Database Commands for the
     * Job. It is possible to define more than one instruction in the COMMAND
     * field. Such instructions are then carried out in the order in which they
     * are written and must be separated by a semi colon and a subsequent new
     * line. Parameters can be replaced in database commands. This is done by
     * the addition of a variable in the form §{param} at any given point in a
     * command. This variable is then given the value of the instruction
     * parameter with the name [param] before execution. */
     ...
     * 
     * \details Database Commands for the Job. It is possible to define more
     * than one instruction in the COMMAND field. Such instructions are then
     * carried out in the order in which they are written and must be separated
     * by a semi colon and a subsequent new line. Parameters can be replaced in
     * database commands. This is done by the addition of a variable in the form
     * §{param} at any given point in a command. This variable is then given the
     * value of the instruction parameter with the name [param] before
     * execution.
     *
    ...
    /** \var database_connection : database connection from table
     * SCHEDULER_MANAGED_CONNECTIONS Name of the selected database connection in
     * table SCHEDULER_MANAGED_CONNECTIONS. */
    ...
    /** \brief getdatabase_connection : database connection from table
     * SCHEDULER_MANAGED_CONNECTIONS
     * 
     * \details Name of the selected database connection in table
     * SCHEDULER_MANAGED_CONNECTIONS.
     *
    ...
    /** \brief setdatabase_connection : database connection from table
     * SCHEDULER_MANAGED_CONNECTIONS
     * 
     * \details Name of the selected database connection in table
     * SCHEDULER_MANAGED_CONNECTIONS.
     *
     * @param database_connection : database connection from table
     *            SCHEDULER_MANAGED_CONNECTIONS */
    public void setdatabase_connection(final SOSOptionString p_database_connection) {
        database_connection = p_database_connection;
    }

    /** \var db_class : SOS Connection class Name of the SOS Connection class for
     * the database: SOSMSSQLConnection SOSMySQLConnection SOSOracleConnection
     ...
     * 
     * \details Name of the SOS Connection class for the database:
     * SOSMSSQLConnection SOSMySQLConnection SOSOracleConnection
     * SOSPgSQLConnection SOSFbSQLConnection SOSDB2Connection
     *
    ...
    /** \var db_driver : Name of the jd Name of the jdbc driver Class */
    ...
    /** \var db_password : database password database password */
    ...
    /** \var db_user : database user database user */
    ...
    /** \var exec_returns_resultset : If stored proc If stored procedures are
     * called which return a result set, this needs to be set to true in order
     * to run the stored procedure as a query. This does not work with the SQL
     * Server 2000 and 2005 jdbc drivers. */
     ...
     * 
     * \details If stored procedures are called which return a result set, this
     * needs to be set to true in order to run the stored procedure as a query.
    ...
    /** \var Max_No_Of_Records_To_Process : Max Number of lines in the result
     * table to process "-1" means no restriction. */
    ...
    /** \brief getMax_No_Of_Records_To_Process : Max Number of lines in the
     * result table to process
     * 
    ...
    /** \brief setMax_No_Of_Records_To_Process : Max Number of lines in the
     * result table to process
     * 
     * \details "-1" means no restriction.
     *
     * @param Max_No_Of_Records_To_Process : Max Number of lines in the result
     *            table to process */
    ...
    /** \var scheduler_order_report_asbody : This setting d This setting
     * determines whether the report should be sent as an attachment (default)
     * or as the content of an e-mail. */
     ...
     * 
     * \details This setting determines whether the report should be sent as an
    ...
    /** \var scheduler_order_report_body : This parameter specifies the report
     * layout in either HTML or plain text formats. The following placeholders
     * can be used in the layout, each within square [ ] brackets, e.g. [date]:
     * [date] - the current date [datetime] - the current date and time
     * [orderid] - the order ID [jobname] - the job name [taskid] - the task ID
     * [sql] - the SQL query used to create the report [xml] - untransformed XML
     * generated from the query results Note that the content of this parameter
     * will be ignored, should the scheduler_order_report_asbody parameter be
     * set to false. */
     ...
     * 
     * \details This parameter specifies the report layout in either HTML or
     * plain text formats. The following placeholders can be used in the layout,
     * each within square [ ] brackets, e.g. [date]: [date] - the current date
     * [datetime] - the current date and time [orderid] - the order ID [jobname]
     * - the job name [taskid] - the task ID [sql] - the SQL query used to
     * create the report [xml] - untransformed XML generated from the query
     * results Note that the content of this parameter will be ignored, should
    ...
    /** \var scheduler_order_report_filename : The name to be used for the
     * attachment file when the report is to be sent as an e-mail. This name
     * will also be used for the permanently saved copy of the report, should a
     * path have been specified using the scheduler_order_report_path parameter.
     * The following placeholders can be used, each placeholder being inserted
     * in square [ ] brackets - e.g. [date]: [date] - the current date [orderid]
     * - the order ID [jobname] - the job name [taskid] - the task ID */
     ...
     * 
     * \details The name to be used for the attachment file when the report is
     * to be sent as an e-mail. This name will also be used for the permanently
     * saved copy of the report, should a path have been specified using the
     * scheduler_order_report_path parameter. The following placeholders can be
     * used, each placeholder being inserted in square [ ] brackets - e.g.
     * [date]: [date] - the current date [orderid] - the order ID [jobname] -
    ...
    /** \var scheduler_order_report_mailbcc : One or more e- One or more e-mail
     * addresses of recipients of blind carbon copies of a report. Multiple
     ...
     * 
     * \details One or more e-mail addresses of recipients of blind carbon
    ...
    /** \var scheduler_order_report_mailcc : One or more e- One or more e-mail
     * addresses of recipients of carbon copies of a report. Multiple addresses
     ...
     * 
     * \details One or more e-mail addresses of recipients of carbon copies of a
    ...
    /** \var scheduler_order_report_mailto : report_mailto: recipients of a
     * report One or more e-mail addresses of recipients of a report. Multiple
     * addresses are to be separated by commas. Should this setting be left
     * empty, then no reports will be sent by e-mail. The reports will however
    ...
    /** \brief getscheduler_order_report_mailto : report_mailto: recipients of a
     * report
     * 
     * \details One or more e-mail addresses of recipients of a report. Multiple
     * addresses are to be separated by commas. Should this setting be left
     * empty, then no reports will be sent by e-mail. The reports will however
     * be generated and saved.
     *
    ...
    /** \brief setscheduler_order_report_mailto : report_mailto: recipients of a
     * report
     * 
     * \details One or more e-mail addresses of recipients of a report. Multiple
     * addresses are to be separated by commas. Should this setting be left
     ...
     * be generated and saved.
     *
     * @param scheduler_order_report_mailto : report_mailto: recipients of a
     *            report */
    ...
    /** \var scheduler_order_report_path : The path to the directory in which a
     * report is saved. The name of the report file is not to be specified here.
     * The following placeholders can be used in the path, inserted in square [
     * ] brackets - e.g.  [date]: [date] - the current date [orderid] - the
     ...
     * 
     * \details The path to the directory in which a report is saved. The name
     * of the report file is not to be specified here. The following
     * placeholders can be used in the path, inserted in square [ ] brackets -
     * e.g.  [date]: [date] - the current date [orderid] - the order ID
    ...
    /** \var scheduler_order_report_send_if_no_result : This setting s This
     * setting specifies whether a report should be sent when the SQL query does
     * not return a result. */
    ...
    public SOSOptionBoolean scheduler_order_report_send_if_no_result = new SOSOptionBoolean(this, conClassName + ".scheduler_order_report_send_if_no_result", // HashMap-Key
     ...
     * 
     * \details This setting specifies whether a report should be sent when the
    ...
    /** \var scheduler_order_report_send_if_result : This setting s This setting
     * specifies whether a report should be sent when an SQL query returns a
     * result. */
     ...
     * 
     * \details This setting specifies whether a report should be sent when an
    ...
    /** \var scheduler_order_report_stylesheet : The style sheet to be used to
     * transform a report from XML format. Both the path and name of the style
     * sheet are optional in this parameter. Should no individual style sheet be
     * available, then the default style sheet can be used. The path can be
     * specified relative to the JobScheduler installation directory. */
     ...
     * 
     * \details The style sheet to be used to transform a report from XML
     * format. Both the path and name of the style sheet are optional in this
     * parameter. Should no individual style sheet be available, then the
     * default style sheet can be used. The path can be specified relative to
    ...
    /** \var scheduler_order_report_subject : report_subject The subject of
     * e-mails to be used to send reports. This field is mandatory should
     * reports be sent by e-mail. The following placeholders can be used,
     * surrounded by square [ ] brackets - e.g. [date]: [date] - the current
     * date [datetime] - the current date and time [orderid] - the order ID
     * [jobname] - the job name [taskid] - the task ID */
     ...
     * 
     * \details The subject of e-mails to be used to send reports. This field is
     * mandatory should reports be sent by e-mail. The following placeholders
     * can be used, surrounded by square [ ] brackets - e.g. [date]: [date] -
     * the current date [datetime] - the current date and time [orderid] - the
     * order ID [jobname] - the job name [taskid] - the task ID
     *
    ...
    } // public JobSchedulerManagedDBReportJobOptionsSuperClass (HashMap
      // JSSettings)

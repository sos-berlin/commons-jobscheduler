...
public class JSBatchInstallerExecuter {
    ...
    private boolean update;												// Alle ausführen auf
    ...
    private void init() {
        ...
        update = jsBatchInstaller.Options().getupdate().isTrue(); // Alle
                                                                  // ausführen
                                                                  // auf
                                                                  // filterInstallHost:filterInstallPort
    ...
    private void createOrder(JSinstallation installation) throws Exception {
        ...
        // spooler_job.set_state_text("Start Installation of " +
        // installation.getHost() + ":" + installation.getServicePort());

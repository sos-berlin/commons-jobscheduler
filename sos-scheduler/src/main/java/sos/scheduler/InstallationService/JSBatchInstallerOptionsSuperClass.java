...
/** \class JSBatchInstallerOptionsSuperClass - Unattended Batch Installation on
 * remote servers
 *
 * \brief An Options-Super-Class with all Options. This Class will be extended
 * by the "real" Options-class (\see JSBatchInstallerOptions. The "real" Option
 ...
 * 20110322142354 \endverbatim \section OptionsTable Tabelle der vorhandenen
 * Optionen
 * 
 ...
 * ("		JSBatchInstallerOptionsSuperClass.auth_file", "test"); // This parameter
...
public class JSBatchInstallerOptionsSuperClass extends JSOptionsClass {
    ...
    @JSOptionDefinition(name = "local_dir", description = "Path to the folder with the generated installation files.", key = "local_dir", type = "SOSOptionFolderName", mandatory = true)
    ...
    /** \brief getlocalDir : Path to the folder with the generated installation
     * files.
     * 
     * \details Path to the folder with the generated installation files.
     *
    ...
    /** \brief setlocal_dir : Path to the folder with the generated installation
     * files.
     * 
     * \details Path to the folder with the generated installation files.
     *
     * @param local_dir : Path to the folder with the generated installation
     *            files. */
    public void setlocal_dir(SOSOptionFolderName p_local_dir) {
        this.local_dir = p_local_dir;
    }

    /** \var update : False: Ignore value of "LastRun" False: Ignore value of
     * "LastRun" True: All installations are executed (matching a given filter). */
     ...
     * 
     * \details False: Only Ignore value of "LastRun" True: All installations
     * are executed (matching a given filter).
     *
     ...
     * 
     * \details False: Ignore value of "LastRun" True: All installations are
     * executed (matching a given filter).
     *
    ...
    /** \var filter_install_host : Only installations are executed which belongs
     * to this host. Only installations are executed which belongs to this host. */
    @JSOptionDefinition(name = "filter_install_host", description = "Only installations are executed which belongs to this host.", key = "filter_install_host", type = "SOSOptionHostName", mandatory = false)
    ...
    /** \brief getfilter_install_host : Only installations are executed which
     * belongs to this host.
     * 
     * \details Only installations are executed which belongs to this host.
     *
    ...
    /** \brief setfilter_install_host : Only installations are executed which
     * belongs to this host.
     * 
     * \details Only installations are executed which belongs to this host.
     *
     * @param filter_install_host : Only installations are executed which
     *            belongs to this host. */
    public void setfilter_install_host(SOSOptionHostName p_filter_install_host) {
        this.filter_install_host = p_filter_install_host;
    }

    /** \var filter_install_port : Only installations are executed which belongs
     * to this port. Only installations are executed which belongs to this port. */
    @JSOptionDefinition(name = "filter_install_port", description = "Only installations are executed which belongs to this port.", key = "filter_install_port", type = "SOSOptionPortNumber", mandatory = false)
    ...
    /** \brief getfilter_install_port : Only installations are executed which
     * belongs to this port.
     * 
     * \details Only installations are executed which belongs to this port.
     *
    ...
    /** \brief setfilter_install_port : Only installations are executed which
     * belongs to this port.
     * 
     * \details Only installations are executed which belongs to this port.
     *
     * @param filter_install_port : Only installations are executed which
     *            belongs to this port. */
    ...
    /** \var installation_definition_file : XML file with installation elements.
     * One element per installation. XML file with installation elements. One
     * element per installation. */
    @JSOptionDefinition(name = "installation_definition_file", description = "XML file with installation elements. One element per installation.", key = "installation_definition_file", type = "SOSOptionInFileName", mandatory = true)
    ...
    /** \brief getinstallation_definition_file : XML file with installation
     * elements. One element per installation.
     * 
     * \details XML file with installation elements. One element per
     * installation.
     *
     * \return XML file with installation elements. One element per
     * installation. */
    public SOSOptionInFileName getinstallation_definition_file() {
        return installation_definition_file;
    }

    /** \brief setinstallation_definition_file : XML file with installation
     * elements. One element per installation.
     * 
     * \details XML file with installation elements. One element per
     * installation.
     *
     * @param installation_definition_file : XML file with installation
     *            elements. One element per installation. */
    ...
    /** \var installation_setup_filename : Name of the jar file that contains the
     * setup */
    @JSOptionDefinition(name = "installation_setup_filename", description = "Name of the jar file that contains the setup.", key = "installation_setup_filename", type = "SOSOptionString", mandatory = true)
    ...
    /** \brief getinstallation_setup_filename: Name of the jar file that contains
     * the setup.
     * 
     * \details Name of the jar file that contains the setup.
     *
    ...
    /** \brief setinstallation_setup_filename : Name of the jar file that
     * contains the setup.
     * 
     * \details Name of the jar file that contains the setup.
     *
     * @param installation_setup_filename : Name of the jar file that contains
     *            the setup. */
    ...
    /** \var installation_job_chain : Job chain with the steps for transfer the
     * installation files and perfo Job chain with the steps for transfer the
     * installation files and perform the setup. The job chain must contain the
     * nodes: -TransferInstallationSetup (FTP) Transfering setup
     * -TransferInstallationFile (FTP) Transfering installation file
     * -PerformInstall (SSH) Executing setup */
    @JSOptionDefinition(name = "installation_job_chain", description = "Job chain with the steps for transfer the installation files and perfo", key = "installation_job_chain", type = "JSOptionJobChainName", mandatory = true)
    ...
    /** \brief getinstallation_job_chain : Job chain with the steps for transfer
     * the installation files and perfo
     * 
     * \details Job chain with the steps for transfer the installation files and
     * perform the setup. The job chain must contain the nodes:
     * -TransferInstallationSetup (FTP) Transfering setup
     * -TransferInstallationFile (FTP) Transfering installation file
     * -PerformInstall (SSH) Executing setup
     *
     * \return Job chain with the steps for transfer the installation files and
     * perfo */
    public JSJobChainName getinstallation_job_chain() {
        return installation_job_chain;
    }

    /** \brief setinstallation_job_chain : Job chain with the steps for transfer
     * the installation files and perfo
     * 
     * \details Job chain with the steps for transfer the installation files and
     * perform the setup. The job chain must contain the nodes:
     ...
     * -PerformInstall (SSH) Executing setup
     *
     * @param installation_job_chain : Job chain with the steps for transfer the
     *            installation files and perfo */

...
/** \class JobSchedulerXslTransformationOptionsSuperClass -
 * JobSchedulerXslTransform
 *
 * \brief An Options-Super-Class with all Options. This Class will be extended
 * by the "real" Options-class (\see JobSchedulerXslTransformationOptions. The
 ...
 * 20110815114129 \endverbatim \section OptionsTable Tabelle der vorhandenen
 * Optionen
 *
 ...
 * ("		JobSchedulerXslTransformationOptionsSuperClass.auth_file", "test"); //
...
public class JobSchedulerXslTransformOptionsSuperClass extends JSOptionsClass {
    ...
    } // public JobSchedulerXslTransformationOptionsSuperClass (HashMap
      // JSSettings)

 ...
 *
 * \brief 
 * An Options-Super-Class with all Options. This Class will be extended by the "real" Options-class (\see CopyJob2OrderParameterOptions.
 ...
 * 
 * \verbatim ;
 * mechanicaly created by  from http://www.sos-berlin.com at 20111104174144 
 * \endverbatim
 ...
 * \verbatim
 private HashMap <String, String> SetJobSchedulerSSHJobOptions (HashMap <String, String> pobjHM) {
	pobjHM.put ("		CopyJob2OrderParameterOptionsSuperClass.auth_file", "test");  // This parameter specifies the path and name of a user's pr
		return pobjHM;

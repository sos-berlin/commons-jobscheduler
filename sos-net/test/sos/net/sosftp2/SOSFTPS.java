...
public class SOSFTPS extends SOSFTP {
	...
	public SOSFTPS(String ftpHost, int ftpPort, String proxyHost, int proxyPort) throws SocketException, IOException,
	...
	public SOSFTPS(String ftpHost, int ftpPort) throws SocketException, IOException,
	UnknownHostException {

...
public class ClassListTest {
    ...
    private final static List<String> expectedClasses = Arrays.asList("com.sos.hibernate.classes.DbItem");

    @Test
    public void test() {
        ClassList classList = new ClassList();
        classList.addClassIfExist("com.sos.scheduler.db.SchedulerInstancesDBItem");     // is
        // not
        // in
        // classpath

...
public class SOSServicePermissionShiro {
	...
	public SOSPermissionShiro getPermissions(@HeaderParam(ACCESS_TOKEN) String accessTokenFromHeader,
		...
		if (currentUser != null && currentUser.getCurrentSubject() != null) {
			...
			addPermission(forUser, sosPermissionJoc.getSOSPermission(),
					"sos:products:joc_cockpit:jobscheduler_master:execute:stop");
			addPermission(forUser, sosPermissionJoc.getSOSPermission(),
			...
			addPermission(forUser, sosPermissionCommands.getSOSPermission(),
					"sos:products:commands:order:change:hot_folder");

			addPermission(forUser, sosPermissionCommands.getSOSPermission(),
					"sos:products:commands:job_chain:view:status");
			addPermission(forUser, sosPermissionCommands.getSOSPermission(),
			...
			addPermission(forUser, sosPermissionCommands.getSOSPermission(),
					"sos:products:commands:process_class:remove");
			addPermission(forUser, sosPermissionCommands.getSOSPermission(),
			...
			addPermission(forUser, sosPermissionCommands.getSOSPermission(),
					"sos:products:commands:schedule:change:hot_folder");
	...
	private JOCDefaultResponse login(String basicAuthorization, String user, String pwd) throws JocException {

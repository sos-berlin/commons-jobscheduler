...
/**
 * \class 		Mail2ActionOptionsSuperClass - Pro Email eine oder mehrere Aktionen ausführen
 *
 * \brief
 * An Options-Super-Class with all Options. This Class will be extended by the "real" Options-class (\see Mail2ActionOptions.
 ...
 *
 * \verbatim ;
 * mechanicaly created by C:\ProgramData\sos-berlin.com\jobscheduler\scheduler.oh\config\JOETemplates\java\xsl\JSJobDoc2JSOptionSuperClass.xsl from http://www.sos-berlin.com at 20121019122956
 * \endverbatim
 ...
 * \verbatim
 private HashMap <String, String> SetJobSchedulerSSHJobOptions (HashMap <String, String> pobjHM) {
	pobjHM.put ("		Mail2ActionOptionsSuperClass.auth_file", "test");  // This parameter specifies the path and name of a user's pr
		return pobjHM;
...
public class SOSMailProcessInboxOptionsSuperClass extends JSOptionsClass {
	...
	/**
	 * \var mailPassword :
	 * The password for login at the mail server.
	 *
	 */
	...
	/**
	 * \var mail_action :
	 * You can use these commands: dump: write the content of the email in file located in mail_dump_dir order: For each mail a order will be generated command: The body of the email will be used as a command. delete: The email will be deleted. You can concatenate several commands by using a comma. They will be handles one ofter the other.
	 *
	 */
	...
	/**
	 * \var mail_body_pattern :
	 * You can specify a regular expression to get only mails matching this filter in the body.
	 *
	 */
	...
	/**
	 * \var mail_jobchain :
	 * If the command is"order" an order will be generated for the job chain defined in mail_jobchain. The order gets all parameters of the job. Additionally the following parameters will be set. "mail_from": Sender of mail "mail_from_name" "mail_message_id": message id of mail "mail_subject": The subject "mail_body": The body "mail_send_at": Date of sending the mail
	 *
	 */
	...
	/**
	 * \var mail_message_folder :
	 * The name of the incoming box, which should be polled.
	 *
	 */
	...
	/**
	 * \var mail_order_id :
	 * With the command "order" an order will be generated for the jobchain defined in mail_jobchain. If you want to specify a special order id, you can use this parameter. We recommend to use the automatically generated order id and leave this parameter empty.
	 *
	 */
	...
	/**
	 * \var mail_order_state :
	 * With the command "order" an order will be generated for the jobchain defined in mail_jobchain. If you want to specify a special order state, you can use this parameter. If an order state is specified, the order starts in the job chain with this state. If leave this empty, the order will start at the beginning of the job chain.
	 *
	 */
	...
	/**
	 * \var mail_order_title :
	 * With the command "order" an order will be generated for the jobchain defined in mail_jobchain. If you want to specify a special title, you can use this parameter. You can see the title in the operations gui of Job Scheduler.
	 *
	 */
	...
	/**
	 * \var mail_scheduler_host :
	 * Hostname of the Job Scheduler that should execute the command. If empty the actual running Job Scheduler containing this job will be uses.
	 *
	 */
	...
	/**
	 * \var mail_scheduler_port :
	 * Port of the Job Scheduler that should execute the command. If empty the actual running Job Scheduler containing this job will be uses.
	 *
	 */
	...
	/**
	 * \var mail_set_seen :
	 * After processing the email it will be set to "readed"
	 *
	 */
	...
	/**
	 * \var mail_subject_filter :
	 * You can specify a filter to get only mails having this filter in the subject. If you want to use regular expressions, you can use the parameter mail_subject_pattern.
	 *
	 */
	...
	/**
	 * \var mail_subject_pattern :
	 * You can specify a regular expression to get only mails matching this expression.
	 *
	 */
	...
	/**
	 * \var mail_use_seen :
	 * If mail_use_seen is true, mail_set_seen will be set to true automatically. Only mails will be processed, which are not readed.
	 *
	 */
	...
	/**
	 * \var mail_user :
	 * The user for login at the mailserver.
	 *
	 */
	 ...
	 * \option min_file_age
	 * \type SOSOptionTime
	 * \brief min_file_age - Minimum age of an Object
	 *
	 * \details

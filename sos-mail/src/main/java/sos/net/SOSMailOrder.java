...
public class SOSMailOrder extends SOSMail {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // jdbc:sqlserver://8of9:2433;sendStringParametersAsUnicode=false;selectMethod=cursor;databaseName=ehp_bkk
        // -user=ehp_bkk -password=ehp_bkk

        // SOSConnection conn =
        // SOSConnection.createInstance("SOSMySQLConnection","com.mysql.jdbc.Driver","jdbc:mysql://wilma.sos:3305/scheduler",

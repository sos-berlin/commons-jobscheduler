 ...
 *
 * \brief
 * An Options-Super-Class with all Options. This Class will be extended by the "real" Options-class (\see SOSSmtpMailOptions.
 ...
 *
 * see \see C:\Users\KB\Documents\xmltest\JobSchedulerSmtpMail.xml for (more) details.
 *
 * \verbatim ;
 * mechanicaly created by  from http://www.sos-berlin.com at 20111124194149
 * \endverbatim
 ...
 * \verbatim
 private HashMap <String, String> SetJobSchedulerSSHJobOptions (HashMap <String, String> pobjHM) {
	pobjHM.put ("		SOSSmtpMailOptionsSuperClass.auth_file", "test");  // This parameter specifies the path and name of a user's pr
		return pobjHM;
...
abstract public class SOSSmtpMailOptionsSuperClass extends JSOptionsClass implements ISOSSmtpMailOptions {
	...
	/**
	 * \var attachment : title Filename and pat
	...
	/**
	 * \var attachment_charset : title charset of attac
	...
	/**
	 * \var attachment_content_type : title content_type of
	...
	/**
	 * \var attachment_encoding : title encoding of atta
	...
	/**
	 * \var charset : title charset of the m
	 * charset of the mail
	 *
	 */
	...
	/**
	 * \var content_type : title content_type of
	...
	/**
	 * \var encoding : title encoding of the
	...
	/**
	 * \var from_name : title name of the send
	 * name of the sender
	 *
	 */
	...
	/**
	 * \var host : title mail server host
	 * mail server host
	 *
	 */
	...
	/**
	 * \var port : title mail server port
	 * mail server port
	 *
	 */
	...
	/**
	 * \var queue_directory : title Mail queue direc
	...
	/**
	 * \var reply_to : title reply address
	 * reply address
	 *
	 */
	...
	/**
	 * \var smtp_password : title smtp user passwo
	 * smtp user password
	 *
	 */
	...
	/**
	 * \var smtp_user : title smtp username
	 * smtp username
	 *
	 */
	...
	/**
	 * \var subject : title Mail Subject
	 * Mail Subject
	 *
	 */

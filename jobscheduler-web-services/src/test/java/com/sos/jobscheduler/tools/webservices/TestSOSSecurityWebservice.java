...
public class TestSOSSecurityWebservice {
    ...
    private static final Logger LOGGER = Logger.getLogger(TestSOSSecurityWebservice.class);
    ...
    public void testStartJob() throws Exception {
        ...
        LOGGER.info(sosCommandSecurityClient.getSosCommandSecurityWebserviceAnswer().getMessage());
        LOGGER.info(sosCommandSecurityClient.getSosCommandSecurityWebserviceAnswer().getJobSchedulerAnswer());
